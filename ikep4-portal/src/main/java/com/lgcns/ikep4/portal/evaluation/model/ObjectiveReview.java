...
public class ObjectiveReview {
	...
	private String revwr2;
	private String revwrnm2;
	private String rvsc2;
	private String rvwsc2;
	private String srtky;
	private String modif;

	private String button;

	private List<ObjectiveReview> reviews;
	...
	public String getRevwr2() {
		return revwr2;
	}

	public void setRevwr2(String revwr2) {
		this.revwr2 = revwr2;
	}

	public String getRevwrnm2() {
		return revwrnm2;
	}

	public void setRevwrnm2(String revwrnm2) {
		this.revwrnm2 = revwrnm2;
	}
	...
	public String getRvwsc2() {
		return rvwsc2;
	}

	public void setRvwsc2(String rvwsc2) {
		this.rvwsc2 = rvwsc2;
	}
	...
	public List<ObjectiveReview> getReviews() {
		return reviews;
	}

	public void setReviews(List<ObjectiveReview> reviews) {
		this.reviews = reviews;
	}

	@Override
	public String toString() {
		return "ObjectiveReview [ayear=" + ayear + ", orgeh=" + orgeh + ", orgtx=" + orgtx + ", aprse=" + aprse
				+ ", aprsenm=" + aprsenm + ", trfgr=" + trfgr + ", fnsco=" + fnsco + ", adjsc=" + adjsc + ", cmqsc="
				+ cmqsc + ", rvsc1=" + rvsc1 + ", rvwsc=" + rvwsc + ", revwr=" + revwr + ", revwrnm=" + revwrnm
				+ ", rvsts=" + rvsts + ", rvstsx=" + rvstsx + ", revwr2=" + revwr2 + ", revwrnm2=" + revwrnm2
				+ ", rvsc2=" + rvsc2 + ", rvwsc2=" + rvwsc2 + ", srtky=" + srtky + ", modif=" + modif + ", button="
