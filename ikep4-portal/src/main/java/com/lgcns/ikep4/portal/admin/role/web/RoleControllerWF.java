 ...
 * @version $Id: RoleControllerWF.java 16243 2011-08-18 04:10:43Z giljae $
 */
@Controller
@RequestMapping(value = "/portal/admin/role/role/workflow")
@SessionAttributes("role")
public class RoleControllerWF extends BaseController {
	...
	public ModelAndView list(
			...
			AdminSearchCondition searchCondition, AccessingResult accessResult) {

		ModelAndView mav = new ModelAndView("portal/admin/role/role/workflow/list");
	...
	public ModelAndView form(
		...
		mav.setViewName("portal/admin/role/role/workflow/form");
	...
	public String onSubmit(
		...
		return "redirect:/portal/admin/role/role/workflow/list.do";
	}

	/**
	 * 해당 역할을 삭제한다.
	 * 
	 * @param role 삭제할 역할 ID
	 * @param request HttpServletRequest 객체
	 * @return String redirect 되는 URI
	 */
