	...
	(function($) {
        ...
        $(document).ready(function() {   
    	    ...
    	    var validOptions = {
                ...
                messages : {
                    options : { 
                        minSize : "<ikep4j:message pre='${preIfmMessage}' key='minSize'/>"
                    },
                    
                    codeId : { 
                        required : "<ikep4j:message pre='${preIfmMessage}' key='selectCode'/>"
                    }
                },    
                notice : {
                },      
    	        submitHandler : function(form) {
                    ...
                    if(item.dataType=="1"){
                        ...
                        item.options = [];
                        $("#itemForm select[name=options] option").each(function(i) {
            ...
            $("#addOptionButton").click(function() {
                ...
                item.lastSeq++;
                var optionValue = "R" + item.lastSeq;
