	...
	(function($){
		...
		$(document).ready(function(){
			...
			writeSubmit = function(targetForm){
				...
				$jq.ajax({
					url : iKEP.getContextRoot() + "/approval/collaboration/proposal/ajaxUdateFile.do?",
					type : "post",
	...
	<div class="blockDetail" style="width: 98%;">
		<div>
			<form id="editForm" name="editForm" method="post" action="">
				...
				<input type="hidden" name="fileItemId" value="${proposal.fileItemId}"/>
						...
						<tr>
							...
							<td>
								...
								<table style="width:100%;" id="ecmTb">
									...
									<c:forEach var="ecmFileData" items="${proposal.ecmFileDataList}" varStatus="ecmFileDataStatus">
