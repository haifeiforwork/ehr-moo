...
(function($){
	$(document).ready(function() {
		...
		$.makeFormData = function(data) {
			...
			formData.push({name : "rfc", value : "OBJECTIVE_EVALUATION_DETAIL"});
			...
			$.ajax({
				...
				, success : function(result) {
					if(result.MSGTY == 'W') {
						...
						$("#ajaxForm").attr("action", "<c:url value='/portal/evaluation/performance/objectiveEvaluationView.do'/>");
						$("#ajaxForm").submit();
					}
				}
...
<div id="wrap">
	...
	<input type="hidden" name="action" value="OBJECTIVE_EVALUATION" />
