...
(function($){
	$(document).ready(function() {
		...
		$.makeFormData = function(data) {
			...
			formData.push({name : "rfc", value : "OBJECTIVE_FEEDBACK_DETAIL"});
		...
		$.setParam = function(data) {
			...
			$ajaxForm.append("<input type=\"hidden\" name=\"action\" value=\"OBJECTIVE_FEEDBACK_VIEW\"/>");
...
<div id="wrap">
	...
	<input type="hidden" name="action" value="OBJECTIVE_FEEDBACK" />
