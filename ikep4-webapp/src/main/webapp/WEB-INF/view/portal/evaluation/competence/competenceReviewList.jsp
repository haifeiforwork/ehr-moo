...
(function($){
	$(document).ready(function() {
		...
		$.pageReload = function() {
			$("#ajaxForm")
				.attr("method", "post")
				.attr("action", "<c:url value='/portal/evaluation/competence/competenceReviewList.do'/>")
				.submit();
		}
		...
		$.businessProcess = function(params) {
			...
			$.ajax({
				url : "<c:url value='/portal/evaluation/competence/competenceReviewProc.do'/>"
				, type : "post"
		...
		$('#reviewTable > tbody').find('a').click(function(e) {
			...
			var url = iKEP.getContextRoot() + "/portal/evaluation/competence/popCompetenceindividualEvaluationList.do?empno=" + empno;
...
<div id="wrap">
	...
	<form id="evaluationForm" name="evaluationForm" method="post" action="<c:url value='/portal/evaluation/competence/competenceReviewList.do'/>">
	<h1 class="title">역량평가 1차 Review</h1>
