...
(function($){
	$(document).ready(function() {
		...
		$.makeFormData = function(data) {
			...
			formData.push({name : "rfc", value : "COMPETENCE_SETUP_DETAIL"});
			...
			$.ajax({
				...
				, success : function(result) {
					if(result.MSGTY == 'W') {
						...
						$("#ajaxForm").attr("action", "<c:url value='/portal/evaluation/competence/competenceSetupView.do'/>");
						$("#ajaxForm").submit();
					}
				}
...
<div id="wrap">
	...
	<input type="hidden" name="action" value="COMPETENCE_SETUP" />
