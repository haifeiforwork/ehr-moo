...
(function($){
	$(document).ready(function() {
		...
		$.fn.calcScore = function() {
			...
			var mtsco = gradeScore == null ? 0 : $.ScoreRound((weight/100) * gradeScore * 10, 1);
		...
		$.fn.bindRadioScoreCheckedHandler = function() {
			$(this).change(function() {
				...
				$(this).calcScore();
				$('[name=evalu_score_sum]').val($.SumScore('mtsco'));
			});
		}
			...
			<c:if test="${not empty etDetail1}">
				<c:forEach var="result" items="${etDetail1}" varStatus="status">
					<tr>
						...
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="S+" <c:if test="${result.MTAPR eq 'S+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="S0" <c:if test="${result.MTAPR eq 'S0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="S-" <c:if test="${result.MTAPR eq 'S-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="A+" <c:if test="${result.MTAPR eq 'A+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="A0" <c:if test="${result.MTAPR eq 'A0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="A-" <c:if test="${result.MTAPR eq 'A-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="B+" <c:if test="${result.MTAPR eq 'B+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="B0" <c:if test="${result.MTAPR eq 'B0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="B-" <c:if test="${result.MTAPR eq 'B-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="C+" <c:if test="${result.MTAPR eq 'C+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="C0" <c:if test="${result.MTAPR eq 'C0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="C-" <c:if test="${result.MTAPR eq 'C-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="D+" <c:if test="${result.MTAPR eq 'D+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="D0" <c:if test="${result.MTAPR eq 'D0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_common_${status.index}" data-semid="FLRT1" value="D-" <c:if test="${result.MTAPR eq 'D-'}">checked</c:if> /></td>
			...
			<c:if test="${not empty etDetail2}">
				<c:forEach var="result" items="${etDetail2}" varStatus="status">
					<tr>
						...
						<td><textarea disabled name="bhidx" class="width_100" rows="3"><c:out value="${result.BHIDX}" /></textarea></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="S+" <c:if test="${result.MTAPR eq 'S+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="S0" <c:if test="${result.MTAPR eq 'S0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="S-" <c:if test="${result.MTAPR eq 'S-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="A+" <c:if test="${result.MTAPR eq 'A+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="A0" <c:if test="${result.MTAPR eq 'A0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="A-" <c:if test="${result.MTAPR eq 'A-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="B+" <c:if test="${result.MTAPR eq 'B+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="B0" <c:if test="${result.MTAPR eq 'B0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="B-" <c:if test="${result.MTAPR eq 'B-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="C+" <c:if test="${result.MTAPR eq 'C+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="C0" <c:if test="${result.MTAPR eq 'C0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="C-" <c:if test="${result.MTAPR eq 'C-'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="D+" <c:if test="${result.MTAPR eq 'D+'}">checked</c:if> /></td>
						<td class="text_center border_right_dotted"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="D0" <c:if test="${result.MTAPR eq 'D0'}">checked</c:if> /></td>
						<td class="text_center"><input type="radio" name="apgrd_stell_${status.index}" data-semid="FLRT2" value="D-" <c:if test="${result.MTAPR eq 'D-'}">checked</c:if> /></td>
						<td class="text_center"><input type="text" name="mtsco" disabled style="width: 60px; text-align:center;" value="${result.MTSCO}" /></td>
					</tr>
				</c:forEach>
			</c:if>
