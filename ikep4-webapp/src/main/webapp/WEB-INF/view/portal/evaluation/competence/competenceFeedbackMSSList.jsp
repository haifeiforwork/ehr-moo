...
(function($){
	$(document).ready(function() {
		...
		$.setParam = function(data) {
			...
			$ajaxForm.append("<input type=\"hidden\" name=\"action\" value=\"COMPETENCE_FEEDBACK_MSS_VIEW\"/>");
...
<div id="wrap">
	...
	<form id="evaluationForm" name="evaluationForm" method="post" action="<c:url value='/portal/evaluation/competence/competenceFeedBackList.do'/>">
		<input type="hidden" name="action" value="COMPETENCE_FEEDBACK_MSS" />

	<h1 class="title">구성원 역량평가 Feedback (${evAyear}년)	</h1>
