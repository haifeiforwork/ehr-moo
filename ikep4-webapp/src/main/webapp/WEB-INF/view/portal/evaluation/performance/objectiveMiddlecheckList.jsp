...
(function($){
	$(document).ready(function() {
		...
		$.makeFormData = function(data) {
			...
			formData.push({name : "rfc", value : "OBJECTIVE_CHECK_DETAIL"});
		...
		$.setParam = function(data) {
			...
			$ajaxForm.append("<input type=\"hidden\" name=\"action\" value=\"OBJECTIVE_MIDDLECHECK_VIEW\"/>");
			...
			$.ajax({
				...
				, success : function(result) {
					if(result.MSGTY == 'W') {
						...
						$("#ajaxForm").attr("action", "<c:url value='/portal/evaluation/performance/objectiveView.do'/>");
						$("#ajaxForm").submit();
					}
				}
...
<div id="wrap">
	...
	<input type="hidden" name="action" value="OBJECTIVE_MIDDLECHECK" />
