									...
									<tbody>
										<c:choose>
											<c:when test="${searchResult.emptyRecord}">
												<tr>
													<td colspan="5" class="emptyRecord"><ikep4j:message pre='${messagePrefix}' key='alert.empty' /></td> 
												</tr>				        
										    </c:when>
										    <c:otherwise>
												<c:forEach var="role" items="${searchResult.entity}" varStatus="status">
													<tr>
														...
														<td class="textLeft"><a onclick="getView('${role.roleId}')" style="cursor:pointer;">${role.description}</a></td>
