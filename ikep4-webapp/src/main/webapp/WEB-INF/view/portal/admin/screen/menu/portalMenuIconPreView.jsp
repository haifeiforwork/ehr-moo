...
<c:set var="preMain" value="ui.portal.admin.screen.menu.portalMenuIconPreView.main"/>
...
<div class="" id="layer_p" title="<ikep4j:message pre='${preMain}' key='layerTitle' />">
	...
	<div id="topMenu2">
		...
		<ul>
			<li><p class="textCenter"><strong>1<ikep4j:message pre="${preMain}" key="theme" /></strong></p><a id="iconMenu_01"></a></li>
			<li><p class="textCenter"><strong>2<ikep4j:message pre="${preMain}" key="theme" /></strong></p><a id="iconMenu_02"></a></li>
			<li><p class="textCenter"><strong>3<ikep4j:message pre="${preMain}" key="theme" /></strong></p><a id="iconMenu_03"></a></li>
			<li><p class="textCenter"><strong>4<ikep4j:message pre="${preMain}" key="theme" /></strong></p><img src="<c:url value='/base/images/common/photo_110x90.gif'/>" alt="noimage" /></li>	
		</ul>
	</div>
	<!--//topMenu End-->
</div>	
