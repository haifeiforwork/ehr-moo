		...
		<c:if test="${!empty param.error}">
			<c:choose>
				...
				<c:when test = "${param.error eq '0'}">
					...
					opener.parent.parent.location.href = "<c:url value='/logout.do'/>";	
					self.close();
				</c:when>
				<c:otherwise>
...
<body>
<form name="newPasswordForm" id="newPasswordForm" action="<c:url value='/passwordModify.do'/>" method="post" >
...
<!--contents -->
<div style="height:100px; padding:15px 0;" id="wrap">
<table width="300"border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:11px;">
  <tbody>
    ...
    <tr>
      <td colspan="3" class="f_right" style="padding-top:10px"><a href="#" class="button_img01" ><span id="submitButton">확인</span></a></td>
      </tr>
  </tbody>
</table>
