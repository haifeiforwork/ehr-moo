...
(function($){
	$(document).ready(function(){
		...
		$("#btnBack").click(function() {
			$("#loanForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/loanList.do'/>");
			$("#loanForm").submit();
		});
...
<form id="loanForm" name="loanForm" method="post" action="<c:url value='/portal/moorimmss/diligencePayMng/loanView.do'/>">
<input type="hidden" name="selEmpNo" value="${params.PERNR}">
<div id="wrap">
