...
(function($){
	$(document).ready(function(){
		$("#btnInterest").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/interestPop.do'/>");
		...
		$("#btnBorrow").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/borrowPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
