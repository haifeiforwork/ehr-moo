...
<link rel="stylesheet" type="text/css" href="/base/css/theme06/jquery_ui.css" />
<link rel="stylesheet" type="text/css" href="/base/css/theme06/theme06.css" />
...
(function($){
	$(document).ready(function(){
		...
		$("#btnSave, #btnDel").click(function(){
			...
			$jq.ajax({
				url : "<c:url value='/portal/moorimmss/diligencePayMng/callPY003OninputPop18.do'/>",
