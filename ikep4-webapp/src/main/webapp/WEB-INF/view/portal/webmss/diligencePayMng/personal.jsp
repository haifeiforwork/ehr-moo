...
(function($){
	$(document).ready(function(){
		...
		$("#familyAdd").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/familyAddPop.do'/>");
		...
		$("#familyDel").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/familyDelPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnAddress").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/addressRegViewPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$(".callFillPerson").click(function(){
			...
			$.ajax({
				url : "<c:url value='/portal/moorimmss/diligencePayMng/callPY003FillPerson.do'/>",
