...
<div class="table_box">
	...
	<div class="list01">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tbody>
				<c:choose>
					<c:when test="${empty prizeDisciplineResult.ET_LIST1}">
						<tr>
							<td colspan="7">조회된 내역이 없습니다.</td>
						</tr>
					</c:when>
					<c:otherwise>
						<c:forEach var="result" items="${prizeDisciplineResult.ET_LIST1}">
							<tr>
...
<div class="table_box">
	...
	<div class="list01">
		...
		<tbody>
			<c:choose>
				<c:when test="${empty prizeDisciplineResult.ET_LIST2}">
					<tr>
						<td colspan="5">조회된 내역이 없습니다.</td>
					</tr>
				</c:when>
				<c:otherwise>
					<c:forEach var="result" items="${prizeDisciplineResult.ET_LIST2}">
						<tr>
