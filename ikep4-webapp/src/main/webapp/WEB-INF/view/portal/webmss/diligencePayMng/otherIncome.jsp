...
(function($){
	$(document).ready(function(){
		$("#btnCredit").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/creditPop.do'/>");
		...
		$("#btnAnnuity").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/annuityPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnHouse").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/housePop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnPayment").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimmss/diligencePayMng/paymentPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
