...
(function($){
	$(document).ready(function(){
		...
		$("a.link").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/approvalPop.do'/>");
		...
		$("#btnApply").click(function(){
			if($("input[name=chkFlag]:checked").length > 0){
				...
				$jq.ajax({
					url : "<c:url value='/portal/moorimess/approveProcess.do'/>",
...
<form id="approvalForm" name="approvalForm" method="post" action="<c:url value='/portal/moorimess/hrApproval.do'/>" >
<div id="wrap">
