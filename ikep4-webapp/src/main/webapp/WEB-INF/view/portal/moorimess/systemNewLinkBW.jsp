...
<script type="text/javascript">
	...
	if((location.hostname).indexOf("eptest")>-1){
		BWserverDomain="http://smrmbdev.moorim.co.kr:8000/sap/bc/bsp/sap/zbw_main/default_new2.htm?P_SABUN=";
	}else{
		if((userBwId.toUpperCase()).indexOf("EPBWIF")>-1){//공용아이디는 다르게.
			BWserverDomain="http://smrmbp02.moorim.co.kr:8000/sap/bc/bsp/sap/zbw_main/default_new2.htm?P_SABUN=";
		}else{
			BWserverDomain="http://smrmbp01.moorim.co.kr:8000/sap/bc/bsp/sap/zbw_main/default_new2.htm?P_SABUN=";
		}
	}
