...
(function($){
	$(document).ready(function(){
		...
		$("a[name=linkField]").click(function(){
			...
			$("#ajaxForm").attr("action", "<c:url value='/portal/moorimess/payMng/loanView.do'/>");
			$("#ajaxForm").submit();
		});
...
<form id="loanForm" name="loanForm" method="post" action="<c:url value='/portal/moorimess/payMng/payEarningView.do'/>">
