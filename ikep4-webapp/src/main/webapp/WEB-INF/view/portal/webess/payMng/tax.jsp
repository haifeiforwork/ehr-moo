...
(function($){
	$(document).ready(function(){
		$("#btnPremium").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/premiumPop.do'/>");
		...
		$("#btnMedical").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/medicalPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnEducation").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/educationPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnDonation").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/donationPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnPension").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/pensionPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
		...
		$("#btnMonthlyRentPop").click(function(){
			...
			$("#popupForm").attr("action", "<c:url value='/portal/moorimess/payMng/monthlyRentPop.do'/>");
			$("#popupForm").attr("target", target);
			$("#popupForm").submit();
