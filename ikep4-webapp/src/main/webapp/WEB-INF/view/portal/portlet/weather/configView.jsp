...
$jq(document).ready(function() {
	...
	$jq("#weatherConfigSave", weatherDiv).click(function() {
		...
		$jq.ajax({
			url : '<c:url value="/portal/portlet/weather/createWeather.do"/>',
			data : {portletConfigId:'${portletConfigId}', portletId:'${portletId}', cityList:cityList},
			type : "post",
			dataType : "html",
	...
	$jq("#weatherNation", weatherDiv).change(function() {
	   ...
	   $jq.get('<c:url value="/portal/portlet/weather/listWeatherNationCity.do"/>?nationCode='+$jq(this).val())
