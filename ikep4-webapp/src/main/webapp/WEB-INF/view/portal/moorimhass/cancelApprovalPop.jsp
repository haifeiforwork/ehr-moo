	...
	$(document).ready(function(){
		...
		$("#btnApprove, #btnReject").click(function(){
			...
			if(process){
				...
				$jq.ajax({
					url : "<c:url value='/portal/moorimhass/cancelOnInput.do'/>",
		...
		<span style="display:inline-block; .display:inline; *zoom:1"  class="list01">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<th class="list03_td_bg">불참내역</th>
						<td class="list03_td">
							<textarea style="width:95%" rows="6"><c:out value="${resultInit.EX_REASON }"/></textarea>
						</td>
					</tr>
				</tbody>
			</table>
