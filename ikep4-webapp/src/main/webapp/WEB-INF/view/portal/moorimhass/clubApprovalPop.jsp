	...
	$(document).ready(function(){
		...
		$("#btnApprove, #btnReject").click(function(){
			...
			if(process){
				...
				$jq.ajax({
					url : "<c:url value='/portal/moorimhass/clubOnInput.do'/>",
			...
			<tbody>
				...
				<tr>
					...
					<td class="list03_td">
						...
						<c:forEach items="${resultCode.ET_JOIN }" var="result">
							<c:if test="${result.KEY eq  exList.ZJOIN}">
				...
				<tr>
					...
					<td class="list03_td">
						<c:out value="${exList.INTXT }"/>
					</td>
					<th class="list03_td_bg">동호회비</th>
					<td class="list03_td f_right">
						<fmt:formatNumber value="${exList.PAYMT}" groupingUsed="true"/>
					</td>
				</tr>
			</tbody>
		</table>
