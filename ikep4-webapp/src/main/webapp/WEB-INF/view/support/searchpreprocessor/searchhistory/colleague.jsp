...
(function($) {
	$(document).ready(function() {
		...
		$("#monthTabButton").data("endIndex", 0).data("option","month");
		$("#weekTabButton").data("endIndex", 0).data("option","week");
		$("#dayTabButton").data("endIndex", 0).data("option","day");
		...
		var ajaxCall= function(settings) {
				...
				var config ={'startIndex':'0','next':'20','searchOption':'today'};
				 ...
				 $.post('<c:url value="/support/searchpreprocessor/searchhistory/ajax/colleague.do"/>',
						 config)
...
<h1 class="none"><ikep4j:message pre="${preLeft}" key="1" /></h1> 
<!--pageTitle Start-->
	
<!--//pageTitle End-->

<div class="subTitle_3">
	<h3><ikep4j:message pre="${preHeader}" key="subTitle.1" /></h3>
</div>
