...
(function($) {
	$(document).ready(function() {
		...
		var ajaxCall= function(settings) {
				...
				var oldIndex=0;
				var config ={'startIndex':'0','next':'20','searchOption':'day'};
	     		if (settings) $.extend(config, settings); 
	     		var isEmpty=true;
	     		
	     		//alert( JSON.stringify(config));
	     		
				 $.post('<c:url value="/support/searchpreprocessor/searchhistory/ajax/populartag.do"/>',
						 config)
...
<h1 class="none"><ikep4j:message pre="${preLeft}" key="6" /></h1> 
<!--pageTitle Start-->
...
<div class="subTitle_3">
	<h3><ikep4j:message pre="${preHeader}" key="subTitle.6" /></h3>
</div>
