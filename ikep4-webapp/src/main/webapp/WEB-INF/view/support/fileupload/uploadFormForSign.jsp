			...
			init : {
				...
				UploadComplete : function() {
					...
					if(uploadResult["status"] == "success") {
						...
						$("#btnSend").children().text("<ikep4j:message key='ui.approval.common.button.confirm'/>");
					}
...
<div>
	<div id="divImage">
				<div class="prPhoto2_Pop_Img">
					<img id="profileImage" src="about:blank" onerror="this.src='<c:url value="/base/images/common/noimage_50x50.gif"/>'" width="100%"/>
				</div>
				<div class="prPhoto2_Pop_Desc">
					<div>
						...
						<a id="btnSend" href="#a" class="button_s"><span><ikep4j:message pre='${preButton}' key='upload' /></span></a>
					</div>
					
					<div class="directive"> 
						<ul>
							<li><span><ikep4j:message pre="${preMessage}" key="file.sign.msg1" /></span></li>	
							<li><span><ikep4j:message pre="${preMessage}" key="file.sign.msg2" /></span></li>	
							<li><span><ikep4j:message pre="${preMessage}" key="file.sign.msg3" /></span></li>	
							<li><span><ikep4j:message pre="${preMessage}" key="file.sign.msg4" /></span></li>	
						</ul>
					</div>
