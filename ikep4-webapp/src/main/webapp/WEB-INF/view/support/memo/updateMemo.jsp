		...
		<div class="memo_view">
						...
						<tbody>
							<tr>
								...
								<td width="88%" style="padding-left:5px;">
									<form id="memoForm" method="post" action="<c:url value='/support/memo/memoModify.do' />"> 
									<spring:bind path="memo.itemId"> <INPUT TYPE="hidden" id="itemId" name="itemId" value="${memo.itemId}"></spring:bind>
									<spring:bind path="memo.contents"> 
										<textarea id="contents" name="${status.expression}"  class="tabletext_memo" cols="" >${memo.contents}</textarea>
			...
			<div class="memo_bottom">
				<div class="memo_btnWrap">
					<a class="button_s"  id="updateButton" class="button" href="#a"><span><ikep4j:message pre='${buttons}' key='save'/></span></a>
					<a id="listButton" class="button_s" href="#a"><span><ikep4j:message pre='${buttons}' key='list'/></span></a>
