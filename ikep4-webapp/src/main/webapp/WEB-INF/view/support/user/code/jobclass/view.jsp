...
<c:set var="jobClass" value="${jobClass}"/>
...
<body>
	...
	<input type="hidden" name="code" value="${jobClass.code}" />
	<!--리스트 테이블 [S]-->
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="2">
		<tr>
			<td width="30%">직급코드</td>
			<td width="70%">&nbsp;<c:out value="${jobClass.code}"/></td>
		</tr>
		<tr>
			<td width="30%">직급이름</td>
			<td width="70%">&nbsp;<c:out value="${jobClass.name}"/></td>
		</tr>
		<tr>
			<td width="30%">정렬순서</td>
			<td width="70%">&nbsp;<c:out value="${jobClass.sort_order}"/></td>
		</tr>
		<tr>
			<td width="30%">등록자(ID/이름)</td>
			<td width="70%">&nbsp;<c:out value="${jobClass.register_id}"/>/<c:out value="${jobClass.register_name}"/></td>
		</tr>
		<tr>
			<td width="30%">등록일</td>
			<td width="70%">&nbsp;<c:out value="${jobClass.regist_date}"/></td>
		</tr>			
	</table>
	<!--리스트 테이블 [E]-->
