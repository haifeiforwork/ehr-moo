...
(function($) {
	$(document).ready(function() {
		...
		var ccnt = "${ctcnt}";
		var rcnt = "${rtcnt}";
    	/*if(pcnt > eyear-syear+1 || ccnt > eyear-syear+1 || rcnt > eyear-syear+1){
    		$(".yearPlus").show();
    		$(".yearMoreOff").hide();
    		$(".yearMoreOn").show();
    	}*/
...
if("${rate.divInfo}" == ""){
	...
	$jq("#mntC1_${rate.yearInfo}").append("${rate.mnt1}");
	$jq("#mntC2_${rate.yearInfo}").append("${rate.mnt2}");
	$jq("#mntC3_${rate.yearInfo}").append("${rate.mnt3}");
	$jq("#mntC4_${rate.yearInfo}").append("${rate.mnt4}");
	$jq("#mntC5_${rate.yearInfo}").append("${rate.mnt5}");
	$jq("#mntC6_${rate.yearInfo}").append("${rate.mnt6}");
	$jq("#mntC7_${rate.yearInfo}").append("${rate.mnt7}");
	$jq("#mntC8_${rate.yearInfo}").append("${rate.mnt8}");
	$jq("#mntC9_${rate.yearInfo}").append("${rate.mnt9}");
	$jq("#mntC10_${rate.yearInfo}").append("${rate.mnt10}");
	$jq("#mntC11_${rate.yearInfo}").append("${rate.mnt11}");
	$jq("#mntC12_${rate.yearInfo}").append("${rate.mnt12}");
}else if("${rate.divInfo}" == "rate"){
	$jq("#varPerC1").append("${rate.mnt1}");
	$jq("#varPerC2").append("${rate.mnt2}");
	$jq("#varPerC3").append("${rate.mnt3}");
	$jq("#varPerC4").append("${rate.mnt4}");
	$jq("#varPerC5").append("${rate.mnt5}");
	$jq("#varPerC6").append("${rate.mnt6}");
	$jq("#varPerC7").append("${rate.mnt7}");
	$jq("#varPerC8").append("${rate.mnt8}");
	$jq("#varPerC9").append("${rate.mnt9}");
	$jq("#varPerC10").append("${rate.mnt10}");
	$jq("#varPerC11").append("${rate.mnt11}");
	$jq("#varPerC12").append("${rate.mnt12}");
}
</c:forEach>
...
$("#readerListViewButton").click( function() {  
	var url = "<c:url value='/support/customer/customerBasicInfo/listReaderView.do?id=${finance.id}&divCode=FM'/>";
...
<input type="hidden" name="edYear" id="edYear" value="${endYear}" />
	...
	<h1 class="none">컨텐츠영역</h1>
                ...
                <ul>           
				 <c:choose>
				 	<c:when test="${finance.registerId eq user.userId || isAdmin eq true}">
				 	 	...
				 	 	<li><a id="readerListViewButton" class="button" href="#a"><span>조회현황</span></a></li>
                   	    <li><a class="button" href="<c:url value='/support/customer/customerFinance/financeList.do'/>"><span>목록</span></a></li>
					</c:when>
					<c:otherwise>
					  <li><a id="createPrintButton"  class="button" href="#a"><span>인쇄</span></a></li>
					  <li><a id="readerListViewButton" class="button" href="#a"><span>조회현황</span></a></li>
						    ...
						    <table summary="new group">
						        ...
						        <tbody>
						            ...
						            <tr>
						            	...
						            	<th name="mnt1_${standardYear}" id="mnt1_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mnt1_${standardYear+loop.count}" id="mnt1_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" style="display:none;text-align:right" name="mnt1_${endYear+1}" id="mnt1_${endYear+1}"></th>
						            	<th name="varMnt1" id="varMnt1" style="text-align:right"></th>
						            	<th name="varPer1" id="varPer1" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<th name="mnt3_${standardYear}" id="mnt3_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mnt3_${standardYear+loop.count}" id="mnt3_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" style="display:none;text-align:right" name="mnt3_${endYear+1}" id="mnt3_${endYear+1}"></th>
						            	<th name="varMnt3" id="varMnt3" style="text-align:right"></th>
						            	<th name="varPer3" id="varPer3" style="text-align:right"></th>
						            </tr>
						                <tr>
									    ...
									    <tr>
											...
											<th name="mnt8_${standardYear}" id="mnt8_${standardYear}" style="text-align:right"></th>
											<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
												<th name="mnt8_${standardYear+loop.count}" id="mnt8_${standardYear+loop.count}" style="text-align:right"></th>
											</c:forEach>
											<th class="yearPlus" style="display:none;text-align:right" name="mnt8_${endYear+1}" id="mnt8_${endYear+1}"></th>
											<th name="varMnt8" id="varMnt8" style="text-align:right"></th>
											<th name="varPer8" id="varPer8" style="text-align:right"></th>
									    </tr>
									    <tr>
									    ...
									    <tr>
											...
											<th name="mnt15_${standardYear}" id="mnt15_${standardYear}" style="text-align:right"></th>
											<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
												<th name="mnt15_${standardYear+loop.count}" id="mnt15_${standardYear+loop.count}" style="text-align:right"></th>
											</c:forEach>
											<th class="yearPlus" style="display:none;text-align:right" name="mnt15_${endYear+1}" id="mnt15_${endYear+1}"></th>
											<th name="varMnt15" id="varMnt15" style="text-align:right"></th>
											<th name="varPer15" id="varPer15" style="text-align:right"></th>
									    </tr>
									    <tr>
									    ...
									    <tr>
											...
											<th name="mnt17_${standardYear}" id="mnt17_${standardYear}" style="text-align:right"></th>
											<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
												<th name="mnt17_${standardYear+loop.count}" id="mnt17_${standardYear+loop.count}" style="text-align:right"></th>
											</c:forEach>
											<th class="yearPlus" style="display:none;text-align:right" name="mnt17_${endYear+1}" id="mnt17_${endYear+1}"></th>
											<th name="varMnt17" id="varMnt17" style="text-align:right"></th>
											<th name="varPer17" id="varPer17" style="text-align:right"></th>
									    </tr>
						        </tbody>
						    </table>
						</div>
						    ...
						    <table summary="new group">
						        ...
						        <tbody>
						            ...
						            <tr>
						            	...
						            	<th name="mntB1_${standardYear}" id="mntB1_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB1_${standardYear+loop.count}" id="mntB1_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB1_${endYear+1}" id="mntB1_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB1" id="varMntB1" style="text-align:right" style="text-align:right"></th>
						            	<th name="varPerB1" id="varPerB1" style="text-align:right" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<td name="mntB294_${standardYear+loop.count}" id="mntB29_${standardYear+loop.count}" style="text-align:right"></td>
						            	</c:forEach>
						            ...
						            <tr>
						            	...
						            	<th name="mntB6_${standardYear}" id="mntB6_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB6_${standardYear+loop.count}" id="mntB6_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB6_${endYear+1}" id="mntB6_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB6" id="varMntB6" style="text-align:right"></th>
						            	<th name="varPerB6" id="varPerB6" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<th name="mntB14_${standardYear}" id="mntB14_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB14_${standardYear+loop.count}" id="mntB14_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB14_${endYear+1}" id="mntB14_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB14" id="varMntB14" style="text-align:right"></th>
						            	<th name="varPerB14" id="varPerB14" style="text-align:right"></th>
						            </tr>
						            <tr>
						            	<th style="text-align:left;">유동부채</th>
						            	<th name="mntB15_${standardYear}" id="mntB15_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB15_${standardYear+loop.count}" id="mntB15_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB15_${endYear+1}" id="mntB15_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB15" id="varMntB15" style="text-align:right"></th>
						            	<th name="varPerB15" id="varPerB15" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<th name="mntB20_${standardYear}" id="mntB20_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB20_${standardYear+loop.count}" id="mntB20_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB20_${endYear+1}" id="mntB20_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB20" id="varMntB20" style="text-align:right"></th>
						            	<th name="varPerB20" id="varPerB20" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<th name="mntB24_${standardYear}" id="mntB24_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB24_${standardYear+loop.count}" id="mntB24_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB24_${endYear+1}" id="mntB24_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB24" id="varMntB24" style="text-align:right"></th>
						            	<th name="varPerB24" id="varPerB24" style="text-align:right"></th>
						            </tr>
						            <tr>
						            ...
						            <tr>
						            	...
						            	<th name="mntB28_${standardYear}" id="mntB28_${standardYear}" style="text-align:right"></th>
						            	<c:forEach begin="1" end="${endYear-standardYear}" varStatus="loop">
						            		<th name="mntB28_${standardYear+loop.count}" id="mntB28_${standardYear+loop.count}" style="text-align:right"></th>
						            	</c:forEach>
						            	<th class="yearPlus" name="mntB28_${endYear+1}" id="mntB28_${endYear+1}" style="text-align:right;display:none;"></th>
						            	<th name="varMntB28" id="varMntB28" style="text-align:right"></th>
						            	<th name="varPerB28" id="varPerB28" style="text-align:right"></th>
						            </tr>
                ...
                <div class="blockButton"> 
                <ul>           
						<li><a class="button" href="<c:url value='/support/customer/customerFinance/modifyFinance.do?id=${finance.id}&buyingCondition=${buyingCondition}&sellingCondition=${sellingCondition}'/>"><span>수정</span></a></li>
