...
<form id="BondsIssueForm" method="post" action="<c:url value='/support/customer/customerBondsIssue/modifyBondsIssue.do'/>" enctype="multipart/form-data" >
	<input type="hidden" name="seqNum" value="${bondsIssue.seqNum}" />
					...
					<table summary="상담이력 상세조회">
						...
						<tbody>
							<tr>
								...
								<td colspan="5"><input name="customer" title="고객명" value="${bondsIssue.customer}"  class="inputbox w100" type="text" /></td>
								<%-- <th scope="row"><span class="colorPoint">*</span>피상담자</th>
								<td><input name="client" title="피상담자"  value="${bondsIssue.client}"  class="inputbox w90" type="text" /></td>
								<th scope="row">연락처</th>
								<td><input name="clientPhone" title="연락처" value="${bondsIssue.clientPhone}"  class="inputbox w90" type="text" /></td> --%>
							</tr>
						   <tr>
						   		<th scope="row">구분</th>
								<td colspan="3">
							...
							<tr>
								...
								<td>
                                	<input name="counselDate" title="등록일" value="${bondsIssue.counselDate}"  class="inputbox datepicker" type="text" value="<ikep4j:timezone date='${bondsIssue.counselDate}'/>" size="15" /> 
								...
								<td colspan="3"><input name="counselor" title="등록자" value="${bondsIssue.counselor}"  class="inputbox w100" type="text" /></td>
								<%-- <th scope="row">영업담당자</th>
								<td><input name="salesman" title="영업담당자" value="${bondsIssue.salesman}"  class="inputbox w90" type="text" /></td> --%>
							</tr>
							
							<tr>
								<th scope="row"><span class="colorPoint">*</span>제목</th>
								<td colspan="5"><input name="subject" title="제목" value="${bondsIssue.subject}" class="inputbox w100" type="text" /></td>
							</tr>
                            <tr>
								<th scope="row"><span class="colorPoint">*</span>이슈내용</th>
								<td colspan="5"><textarea name="content" class="w100" title="상담내용" cols="" rows="10">${bondsIssue.content}</textarea></td>
							</tr>
                            <%-- <tr>
								<th scope="row">조치사항 및<br />조치결과</th>
								<td colspan="5"><textarea name="actions"   class="w100" title="조치사항 및 조치결과" cols="" rows="10">${bondsIssue.actions}</textarea></td>
							</tr> --%>
                        </tbody>
					</table>
				</div>
