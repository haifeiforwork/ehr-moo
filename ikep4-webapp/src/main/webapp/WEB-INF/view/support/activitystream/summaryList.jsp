						...
						<tbody>
							...
							<c:choose>
							    <c:when test="${searchResult.emptyRecord}">
									<tr>
										<td colspan="1" class="emptyRecord"><ikep4j:message pre='${preMessage}' key='list.empty' /></td> 
									</tr>				        
							    </c:when>
							    <c:otherwise>
									...
									<tr>
										<td class="textLeft">
											${activityStream.activityStr} [<ikep4j:timezone pattern="yyyy.MM.dd HH:mm:ss" date="${activityStream.activityDate}"/>]
										</td>	
									</tr>
									</c:forEach>				      
							    </c:otherwise> 
