...
<c:set var="preHeader"  value="ui.support.note.createFolderView.header" /> 
<c:set var="preDetail"  value="ui.support.note.createFolderView.detail" />
<c:set var="prefix"  	value="ui.support.note.createFolderView" /> 
...
(function($) {   
	...
	$(document).ready(function() {  
		...
		$("a[name=createFolderButton]").click(function() {   
...
//-->
	...
	<div class="blockButton" id="divButton"> 
		<ul> 
			<li><a name="createFolderButton" class="button" href="#a"><span><ikep4j:message pre='${preButton}' key='save'/></span></a></li>
