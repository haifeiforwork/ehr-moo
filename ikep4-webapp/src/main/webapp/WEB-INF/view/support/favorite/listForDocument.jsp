...
<div id="wrapper">
		...
		<div id="blockMain">
			...
			<div id="mainContents" class="conPPS">
				...
				<h1><ikep4j:message pre='${preDetail}' key='favoriteDocument' /></h1>
				
				<form id="searchForm" method="post" action="<c:url value="/support/favorite/getSubListForDocument.do" />" onsubmit="return false">  
