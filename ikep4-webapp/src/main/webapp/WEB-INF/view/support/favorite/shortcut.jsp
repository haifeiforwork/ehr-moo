...
<div class="subTitle_4">
	...
	<div class="btn_more"><a href="<c:url value="/support/favorite/getListForPeople.do" />" target="mainFrame" onclick="hidePersonalBox()"><img src="<c:url value="/base/images/common/btn_more.gif" />" alt="more" /></a></div>
</div>
...
<div class="subTitle_4">
	...
	<div class="btn_more"><a href="<c:url value="/support/favorite/getListForDocument.do" />" target="mainFrame" onclick="hidePersonalBox()"><img src="<c:url value="/base/images/common/btn_more.gif" />" alt="more" /></a></div>
</div>
