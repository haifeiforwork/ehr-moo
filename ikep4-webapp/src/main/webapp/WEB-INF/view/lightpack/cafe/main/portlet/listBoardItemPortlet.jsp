...
(function($) {
	...
	<div class="tableList_2 mb15">
		...
		<div class="subTitle_1">
			...
			<div class="btn_more"><a href="<c:url value='/lightpack/cafe/board/boardItem/listBoardItemView.do'/>?cafeId=${cafeId}&amp;boardId=${board.boardId}"><img src="<c:url value='/base/images/common/btn_more.gif'/>" alt="more" /></a></div>
		</div>
		<!--//subTitle_1 End-->	
