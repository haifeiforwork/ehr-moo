...
<c:set var="preDetail"  value="message.lightpack.cafe.board.boardTagging.listRelatedBoardView.detail" /> 
<%-- 메시지 관련 Prefix 선언 Start --%>  
<c:set var="preList"  value="message.lightpack.cafe.board.boardTagging.listBoardTagging" /> 
...
<ul>
	...
	<li>
		<span>  
			<a href="<c:url value='/lightpack/cafe/board/boardItem/readBoardItemView.do?boardId=${relatedBoardItem.boardId}&itemId=${relatedBoardItem.itemId}&searchConditionString=${searchConditionString}'/>">${relatedBoardItem.title}</a>
