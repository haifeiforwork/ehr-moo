...
<div id="pageTitle" class="btnline"> 
	...
	<div class="blockButton"> 
		<ul>
			...
			<li><a class="button" href='<c:url value='/lightpack/cafe/board/boardItem/listBoardItemView.do?boardId=${boardItem.boardId}&amp;searchConditionString=${searchConditionString}&amp;
