	...
	(function($) {
        ...
        $(document).ready(function() {   
			...
			$("#itemFormButton a").click(function(){
			    switch (this.id) {
                    //case "saveButton":
                       ...
                       // $("#itemForm").attr("action", "<c:url value='/lightpack/award/awardAdmin/createCategoryAward.do'/>");
        			   // break;
                    case "closeButton":
                    	window.close();
                        break;
			...
			$jq("#saveButton").click(function() {   
	    		...
	    		$.ajax({
					url : "<c:url value='/lightpack/award/awardAdmin/createCategoryAward.do?awardId=${categoryAwardId.awardId}' />",
...
<div id="popup">
	...
	<!--popup_title Start-->
	<div id="popup_title">
		<h1><ikep4j:message pre='${preButton}' key='categoryManage'/></h1>
	...
	<form id="itemForm" name="itemForm" method="post" action="" onsubmit="return false;">	
		...
		<!--blockButton Start-->
		<div id="itemFormButton"  style="text-align:center"  class="blockButton"> 
		<ul>
	...
	<!--popup_footer Start-->
	<div id="popup_footer">
		Copyright ⓒ 2011. All Rights Reserved. Powered by iKEP4
	</div>
	<!--//popup_footer End-->
