		    ...
		    <c:otherwise>
				...
				<tr class="bgWhite awardItemLine"> 
					<c:if test="${permission.isSystemAdmin}"> <%--[관리자]일괄 삭제를 위한 체크박스 허용--%>
						<td style="width:20px;"><input name="checkboxAwardItem" class="checkbox" title="checkbox" type="checkbox" value="${awardItem.itemId}" /></td>
					</c:if>	 			
					<td>
						...
						<div class="summaryViewCon"><ikep4j:extractText text="${awardItem.contents}" length="300"/></div>
						<!-- 
