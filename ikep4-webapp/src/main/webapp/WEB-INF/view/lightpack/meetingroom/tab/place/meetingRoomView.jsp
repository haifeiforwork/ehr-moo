...
<div class="blockDetail">
	...
	<table summary="<ikep4j:message pre='${preDetail}' key='main.title' />">
		...
		<tbody>
			...
			<spring:bind path="meetingRoom.meetingRoomName">
			<tr> 
				...
				<td width="85%" class="textLeft" colspan="3">
					...
					<span id="id_favorite">
						<a class="ic_rt_favorite valign_middle ${checkFavorite eq 'Y' ? 'select' : ''}"
							...
							title="<ikep4j:message pre='${preDetail}' key='delFavorite' />"
						href="#${meetingRoom.meetingRoomId}"><span>meeting room favorite</span></a>	
					</span>
				</td> 
			</tr>				
			</spring:bind>
			
			<spring:bind path="meetingRoom.buildingName">
			<tr> 
				<th scope="row" width="15%"><ikep4j:message pre='${preDetail}' key='${status.expression}' /></th>
				<td class="textLeft">
					${status.value}
			...
			<spring:bind path="meetingRoom.floorName">
			...
			<spring:bind path="meetingRoom.managerName">
			<tr> 
				<th scope="row" width="15%"><ikep4j:message pre='${preDetail}' key='${status.expression}' /></th>
				<td class="textLeft">
					${status.value}
			...
			<spring:bind path="meetingRoom.equipmentName">
			<tr> 
				<th scope="row"><ikep4j:message pre='${preDetail}' key='${status.expression}' /></th>
