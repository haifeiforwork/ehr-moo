...
(function($) {
								...
								if(
									...
									$(this).parent().click(function(event) {
										...
										if(!shd.schedulePublic) {
											if($("#regionId").is("*")) 
												currentCategoryId = $("#regionId").val();
	...
	getList = function(date) {
		...
		var data = { regionId:$("#regionId").val(), curDate:date.getTime() ,mid:"${param.mid}"};
		$.get("<c:url value="/lightpack/meetingroom/day/cartooletcList.do" />", data)
