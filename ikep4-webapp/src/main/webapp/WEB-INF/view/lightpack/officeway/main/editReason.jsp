	...
	(function($) {
        ...
        $(document).ready(function() {   
			...
			$jq("#saveButton").click(function() {   
	    		...
	    		$.ajax({
					url : "<c:url value='/lightpack/officeway/createCategoryBoard.do?boardId=100000000002' />",
...
<div class="blockListTable">
	...
	<form id="itemForm" name="itemForm" method="post" action="" onsubmit="return false;">	
				...
				<tbody>   
    	      		<tr id="optionValueTr">
    					...
    					<td style="padding-top:7px;">
                            ...
                            <a id="addOptionButton" class="button_img05" href="#a"><span><ikep4j:message pre='${preDetail}' key='add'/></span></a>
  							<a id="updateOptionButton" class="button_img05" href="#a"><span><ikep4j:message pre='${preDetail}' key='edit'/></span></a>
                            <a id="initOptionButton" class="button_img05" href="#a"><span><ikep4j:message pre='${preDetail}' key='cancel'/></span></a><br>
							<table border="0" style="width:500px;">
							  <tr>
							    ...
							    <td class="border_none">
							    	<ul>
								    	<li>
			                            	<a id="moveUpButton" class="button_img05" href="#a" ><span>▲</span></a>
			                            </li>
			                            <li>
			                            	<a id="moveDownButton" class="button_img05" href="#a"><span>▼</span></a>
			                            </li>
		                            </ul>
							    </td>
							  </tr>
							  <tr>
							    <td class="border_none pt5" colspan="2" style="padding-left:175px; padding-left:176px\9;">
							    	<a id="editOptionButton" class="button_img05" href="#a"><span><ikep4j:message pre='${preDetail}' key='edit'/></span></a>
		                            <a id="removeOptionButton" class="button_img05" href="#a"><span><ikep4j:message pre='${preDetail}' key='delete'/></span></a>
							    </td>
							  </tr>
							</table>                                  
		...
		<!--blockButton Start-->
		<div id="itemFormButton"  class="nblockButton"> 
