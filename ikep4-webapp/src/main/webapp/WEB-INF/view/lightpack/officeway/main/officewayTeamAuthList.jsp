			...
			<table style="width:50%;">
				...
				<tbody>   
    			    <tr>
    					...
    					<th style="text-align:center;border-left:1px solid #e0e0e0;border-right:1px solid #e0e0e0;">부서</th>
    				</tr>
    				 <c:forEach var="teams" items="${officewayTeamAuthList}">
    				<tr>
						...
						<td style="text-align:center;border-left:1px solid #e0e0e0;border-right:1px solid #e0e0e0;">
							<a href="<c:url value='/lightpack/officeway/officewayTeamAuthEditForm.do?teamId=${teams.teamId}'/>" > ${teams.teamName}</a>
						</td>
    			    </tr>
    			    </c:forEach>
    			</tbody>
