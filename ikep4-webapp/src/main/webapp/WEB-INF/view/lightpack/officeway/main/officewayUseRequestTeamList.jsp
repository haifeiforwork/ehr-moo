...
//<!--
	...
	function getList() {
		...
		$jq("#searchForm").attr("action", "<c:url value='/lightpack/officeway/officewayUseRequestTeamList.do' />");
			...
			<form id="searchForm" name="searchForm" method="post" onsubmit="getList(); return false;" action="">
				...
				<ul>
					<c:if test="${periodCheck}">
						...
						<li><a id='updateButton' class='button' href='<c:url value='/lightpack/officeway/officewayUseRequestTeamListUpdateForm.do'/>'><span>수정</span></a></li>
						</c:if>
