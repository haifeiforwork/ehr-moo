...
//-->
	...
	<!--blockListTable Start-->
			...
			<form id="listForm" name="listForm" method="post" action="<c:url value='/lightpack/officeway/OfficewayTeamAuthList.do'/>" >
				<input type="hidden" name="teamId" value=""/> 
			</form>
			<form id="requestForm" name="requestForm" method="post" action="<c:url value='/lightpack/officeway/officewayTeamAuthSave.do'/>" >
