...
//<!--
	...
	function getList() {
		...
		$jq("#searchForm").attr("action", "<c:url value='/lightpack/officesupplies/officesuppliesUseRequestOtherTeamList.do?teamId=${teamId}' />");
...
<div id="reserveDiv">
	...
	<div class="blockListTable">
		<div id="listDiv">
			<form id="listForm" name="listForm" method="post" action="<c:url value='/lightpack/officesupplies/officesuppliesUseRequestOtherTeamListPayment.do'/>" ><input type="hidden" name="teamId" value="${teamId}"/> </form>
			<form id="requestForm" name="requestForm" method="post" action="<c:url value='/lightpack/officesupplies/officesuppliesUseRequestOtherTeamUpdate.do'/>" >
