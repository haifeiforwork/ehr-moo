...
//<!--
	...
	function getList() {
		...
		$jq("#searchForm").attr("action", "<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamListPayment.do' />");
			...
			<form id="searchForm" name="searchForm" method="post" onsubmit="getList(); return false;" action="">
				...
				<ul>
					<c:if test="${periodCheck}">
						...
						<li><a id='updateButton1' class='button' href='<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamListUpdateForm.do'/>'><span>수정</span></a></li>
						</c:if>
						<c:if test="${oftlRole && tmpStatus2 == '1'}">
						<li><a id="approveButton1" class="button" href="#a"><span>승인</span></a></li>
				...
				<ul>
					<c:if test="${periodCheck}">
						...
						<li><a id='updateButton2' class='button' href='<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamListUpdateForm.do'/>'><span>수정</span></a></li>
						</c:if>
						<c:if test="${oftlRole && tmpStatus2 == '1'}">
						<li><a id="approveButton2" class="button" href="#a"><span>승인</span></a></li>
