...
<!--// 
	...
	$jq("#itemForm").attr("action", "<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamStatistics.do' />");
	$jq("#itemForm")[0].submit();
	}
	
	function teamViewPopup(teamId, calMnt) {
		var url = "<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamList.do'/>?teamId="+teamId+"&viewMonth="+calMnt;
