...
<div id="reserveDiv">
	...
	<div class="blockListTable">
		<div id="listDiv">
			<form id="listForm" name="listForm" method="post" action="<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamListPayment.do'/>" ></form>
			<form id="requestForm" name="requestForm" method="post" action="<c:url value='/lightpack/officesupplies/officesuppliesUseRequestTeamUpdate.do'/>" >
