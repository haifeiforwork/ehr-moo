...
(function($) {
	...
	writeSubmit = function(targetForm){
		...
		$jq.ajax({
			url : '<c:url value="/lightpack/todo/webDiaryCreateTodoAjax.do"/>',
			type : "post",
			data : data,
...
*/
				...
				<div class="blockDetail">
					<form id="orderForm" name="orderForm" action="<c:url value="/lightpack/todo/webDiaryCreateTodo.do"/>" method="post">
						...
						<tbody>
							...
							<tr>
								...
								<div>
									...
									<textarea id="taskContents" name="${status.expression}" class="w100" title="<ikep4j:message pre='${prefix}' key='form.contents'/>" cols="" rows="10"></textarea>
									</spring:bind>
								</div>
								</td>	
							</tr>							
