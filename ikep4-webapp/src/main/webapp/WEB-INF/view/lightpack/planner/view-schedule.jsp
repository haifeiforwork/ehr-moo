...
<script type="text/javascript" src="<c:url value="/base/js/units/lightpack/planner/view_schedule.js"/>"></script>
		...
		$(document.body).ready(function() {
			...
			$("a.btn_update").click(function() {
				...
				if(expVer.indexOf("11.") > 0){
					iKEP.returnSchedulePopup({action:"update",scheduleId:scheduleId});
				}else{
