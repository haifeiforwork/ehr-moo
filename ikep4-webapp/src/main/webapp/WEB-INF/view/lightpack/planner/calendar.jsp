...
<script type="text/javascript" src="<c:url value="/base/js/units/lightpack/planner/ikep4cal.eventMgmt.js"/>"></script>
<script type="text/javascript" src="<c:url value="/base/js/units/lightpack/planner/ikep4Calendar.js"/>"></script>
<script type="text/javascript" src="<c:url value="/base/js/units/lightpack/planner/ikep4cal.js"/>"></script>
...
<input id="optCheck2" name="optCheck2" type="hidden" />
	...
	<!--			<tr id="opt_tr">
					...
					<td>
						<div class="optCheck">
							<label><input id="optCheck1" name="optCheck1" class="checkbox" type="checkbox" value="3" />고객사 방문</label>
						</div>
					</td>
				</tr>-->
				<tr id="alarm_tr">
				...
				<tr>
					...
					<td>
       					<input id="place" title="<ikep4j:message pre="${preLabel}" key="place" />" class="inputbox" style="width:400px;" type="text"/>
