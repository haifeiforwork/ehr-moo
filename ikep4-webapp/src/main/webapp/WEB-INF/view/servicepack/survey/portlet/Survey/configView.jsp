...
(function($){	 
	$(document).ready(function() { 
		$("#updatePageCount").click(function() { 
		    $.post('<c:url value="/servicepack/survey/portlet/updatePageCount.do"/>', $("#configForm").serialize()) 
		    .success(function(data) {
		    	$jq("#configForm${portletConfigId}").parent().parent().parent().trigger("click:reload");
