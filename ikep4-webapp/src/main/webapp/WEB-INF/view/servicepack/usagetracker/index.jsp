...
(function($) {
	...
	$(document).ready(function() {
		...
		$.post('<c:url value="/servicepack/usagetracker/main/ajax/0/report.do"/>')
		 .success(function(data) {
				 var s1 = [];
				 var ticks = [];
				 $(data).each(function(index){
					 ticks.push(week[parseInt(this.moduleId)-1]); 
					 s1.push(this.usageCount);
				 });
		...
		$.post('<c:url value="/servicepack/usagetracker/main/ajax/2/report.do"/>')
		 .success(function(data) {
				 var s1 = [];
				 $(data).each(function(index){
					 var ticks = [];
					 var module_id = this.moduleId.replace('Internet Explorer','IE');
					 ticks.push(module_id +":" + this.usageCount); 
		...
		$.post('<c:url value="/servicepack/usagetracker/main/ajax/3/report.do"/>')
		 .success(function(data) {
				 var s1 = [];
				 $(data).each(function(index){
					 var ticks = [];
...
-->
	...
	<div class="blockLeft" style="width:49%">
		<div class="gray_box">			
			<div class="box_title">
				<h3><ikep4j:message pre='${preUi}' key='loginStat'/></h3>
				<div class="r_btns"><a href="<c:url value='/servicepack/usagetracker/stats/login.do'/>"><img src="<c:url value='/base/images/common/btn_more.gif'/>" alt="more" /></a></div>
			</div>			
			<div class="usage_graph">
				<div id="loginStatsGraph" style="margin-top:10px;;height:230px;"></div>
			</div>
		</div>
	</div>
	<!--blockLeft End-->
	...
	<div class="blockRight" style="width:49%">
		<div class="gray_box">			
			<div class="box_title">
				<h3><ikep4j:message pre='${preUi}' key='browserStat'/></h3>
				<div class="r_btns"><a href="<c:url value='/servicepack/usagetracker/stats/browser.do'/>"><img src="<c:url value='/base/images/common/btn_more.gif'/>" alt="more" /></a></div>
			</div>			
			<div class="usage_graph">
				<div id="browserStatsGraph" style="margin-top:10px;height:230px;"></div> 
			</div>
		</div>
	</div>
	<!--blockRight End-->
	...
	<div class="blockLeft" style="width:49%">
		<div class="gray_box">			
			<div class="box_title">
				...
				<div class="r_btns"><a href="<c:url value='/servicepack/usagetracker/rank/menu.do'/>"><img src="<c:url value='/base/images/common/btn_more.gif'/>" alt="more" /></a></div>
			</div>
			<div class="usage_graph">
	...
	<div class="blockRight" style="width:49%">
		<div class="gray_box">			
			<div class="box_title">
				<h3><ikep4j:message pre='${preUi}' key='portletRank'/></h3>
				<div class="r_btns"><a href="<c:url value='/servicepack/usagetracker/rank/portlet.do'/>"><img src="<c:url value='/base/images/common/btn_more.gif'/>" alt="more" /></a></div>
			</div>			
			<div class="usage_graph">
				<div id="portletusageGraph" style="margin-top:10px; margin-left:10px;margin-right:10px;height:350px;"></div>
			</div>
		</div>
	</div>
	<!--blockRight End-->					