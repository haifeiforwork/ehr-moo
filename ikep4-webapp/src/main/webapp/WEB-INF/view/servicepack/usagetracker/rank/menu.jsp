...
(function($) {
	$(document).ready(function() {
		...
		$("#excelDownload").click(function() { 
			$jq("#searchForm").attr("action","<c:url value='/servicepack/usagetracker/rank/excel/menu.do'/>");
			$jq("#searchForm").submit(); 
			return false; 
		});
		...
		var setAction = function(){
			$jq("#searchForm").attr("action","<c:url value='/servicepack/usagetracker/rank/menu.do'/>");
		};
...
-->
				...
				<!--//pageTitle End-->
				<form id="searchForm" action="<c:url value='/servicepack/usagetracker/rank/menu.do'/>" method="post">
				...
				<div class="corner_RoundBox02">
					<div class="blockLeft" style="width:48%">
						<ul class="graphText">
							<li><span class="emphasis"><ikep4j:message pre='${preStats}' key='left.menu.${result.searchOption}'/></span>
							</li>
							<li>
								 <span class="emphasis browser">${result.maxUseAge}</span><span class="emphasis"><ikep4j:message pre='${preStats}' key='left.menu.max'/></span>
							</li>
							<li>
								 <span class="emphasis"><ikep4j:message pre='${preStats}' key='left.menu.min'/></span>
							</li>
							<li>	 
								 <span class="emphasis browser2">${result.minUseAge}</span>
							</li>
							<li>	 
								<span class="emphasis"><ikep4j:message pre='${preStats}' key='left.menu.end'/></span>
							</li>
						</ul>
						<div class="clear"></div>
					</div>
					<div class="blockRight" style="width:50%">
						<div class="usage_graph" style="text-align:center;">
							<span><strong><ikep4j:message pre='${preStats}' key='top.menu.${result.searchOption}'/> <ikep4j:message pre='${preStats}' key='top.menu.end'/></strong></span>
