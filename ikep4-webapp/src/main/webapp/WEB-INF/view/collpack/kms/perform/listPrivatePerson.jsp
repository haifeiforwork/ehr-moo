							...
							<tr>
							   ...
							   <td colspan="8">
							   		<select name="isknowHowBox" id="isknowHowBox">		
                                    	...
                                    	<option value="3" <c:if test="${'3' eq searchCondition.searchIsknowhow}">selected="selected"</c:if>>원문 게시판</option>                             	
                                    </select>
							   </td>
							</tr>
							<tr>
                               ...
                               <td width="12%">     
                                    <spring:bind path="searchCondition.isPerson">                    
                               		<input type="radio" name="isPerson" id="isPerson" value="Y" <c:if test="${searchCondition.isPerson eq 'Y'}">checked="checked"</c:if> />
									<label for="radio1"><ikep4j:message key='message.collpack.kms.perform.title.private' /></label>
									<input type="radio" name="isPerson" id="isPerson" value="N" <c:if test="${searchCondition.isPerson eq 'N'}">checked="checked"</c:if> />
