					...
					<tbody>					
						...
						<tr class="boardItemLine">
							<td>
								...
								<div class="summaryViewCon"><a class="anchorBoardItem" href="<c:url value='/collpack/collaboration/board/boardItem/readBoardItemLinkView.do?workspaceId='/>${boardItem.workspaceId}&amp;boardId=${boardItem.boardId}&amp;itemId=${boardItem.itemId}" title="${boardItem.title}">${ikep4j:replaceQuot(fn:substring(boardItem.contents, 0, 300))}</a></div>
	        					</spring:htmlEscape>
