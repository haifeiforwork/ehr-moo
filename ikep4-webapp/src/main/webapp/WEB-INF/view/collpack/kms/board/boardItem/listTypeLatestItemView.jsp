				...
				<tr>
					...
					<td class="textLeft">
						...
						<B>
							...
							<a name="announceItem" href="<c:url value='/collpack/kms/board/boardItem/readLatestItemView.do?itemId=${announceItem.itemId}&isKnowhow=${announceItem.isKnowhow}&amp;searchConditionString=${searchConditionString}&amp;popupYn=${popupYn}&amp;pageGubun=${pageGubun}'/>">${announceItem.title}</a>
						<c:if test="${announceItem.status == 5}">
						</B>
						</c:if>
						</span>
