...
(function($) {
	...
	defaultSetting = function(workspaceId) {		
		$jq.get('<c:url value="/collpack/kms/member/updateWorkspaceDefaultSet.do"/>',
			...
			function(data){
				location.href="<c:url value='/collpack/kms/main/Kms.do' />?workspaceId="+workspaceId;
			}
		)
		return false;
	};
...
///////////////////////////////////////////////////////////////////////////////////////////////		
		if('${boardId}'!=null && '${boardId}'!="")
			...
			iKEP.iFrameMenuOnclick('<c:url value="/collpack/kms/main/KmsBody.do"/>');
...
////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if("${pageName}" == "create"){
			iKEP.iFrameMenuOnclick("<c:url value='/collpack/kms/board/boardItem/createBoardItemView.do?boardId=0&isKnowhow=0&searchConditionString='/>");
		}
////////////////////////////////////////////////////////////////////////////////////////////////
	});
})(jQuery);
//-->
		...
		<!--leftMenu Start-->
                ...
                <h2 style="margin-bottom:10px;">
                	<a href="<c:url value="/collpack/kms/main/Kms.do" />">
