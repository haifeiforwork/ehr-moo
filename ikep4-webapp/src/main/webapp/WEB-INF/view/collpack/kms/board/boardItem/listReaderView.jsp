...
<div class="contentIframe">
	...
	<div class="blockListTable">
		<div id="listDiv">
			<form id="searchForm" name="searchForm" method="post"  action="<c:url value='/collpack/kms/board/boardItem/listReaderView.do'/>">
				...
				<spring:bind path="searchCondition.boardItemId">
