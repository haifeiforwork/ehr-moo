...
(function($){	 
	...
	$(document).ready(function() { 
		...
		$("#saveButton").click(function() {   
			if($("input[name=viewYnnCheck]").is(":checked")) {
				$("input[name=viewYn]").val("Y");
			} else {
				$("input[name=viewYn]").val("N");
			} 
			
			if($("input[name=alarmYnCheck]").is(":checked")) {
				$("input[name=alarmYn]").val("Y");
			} else {
				$("input[name=alarmYn]").val("N");
			} 
...
<form id="searchUserPermForm" method="post" onsubmit="return false" action="<c:url value='/collpack/kms/admin/registKeyInfoPermission.do'/>">
<!--mainContents Start-->	 
<!--pageTitle Start-->
                    ...
                    <table id="infoWinner">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th scope="row"><ikep4j:message pre='${preList}' key='viewyn' /></th>
                                <td>
                                <input type="checkbox" id="viewYnnCheck" name="viewYnnCheck" value="${adminPermission.viewYn}" <c:if test="${adminPermission.viewYn=='Y'}">checked</c:if> />${adminPermission.viewYn}
                                <input type="hidden" id="viewYn" name="viewYn" value="${adminPermission.viewYn}"/>
                                </td>
                                 <th scope="row"><ikep4j:message pre='${preList}' key='alarmyn' /></th>
                                 <td>
                                 <input type="checkbox" id="alarmYnCheck" name="alarmYnCheck" value="${adminPermission.alarmYn}" <c:if test="${adminPermission.alarmYn=='Y'}">checked</c:if> />${adminPermission.alarmYn}
                                 <input type="hidden" id="alarmYn" name="alarmYn" value="${adminPermission.alarmYn}"/>
                                 </td>
                            </tr>
                        </tbody>
                    </table>
