...
//-->
				...
				<ul>
					...
					<li class="liFirst opened">
						...
						<a href="#a" id="type"><ikep4j:message pre="${prefix}" key="type" /></a>
						<ul class="type">
				...
				<div class="leftSelect mb10">
					<select onchange="goWorkspace(this.value)" name="typeId"  title="<ikep4j:message pre="${prefix}" key="myCollaboration.select" />">
						<option value="" > <ikep4j:message pre="${prefix}" key="myCollaboration" /> </option>
				...
				<div class="blockButton_2"> 
					<a class="button_2 normal" href="#a" onclick="contentIframeShow();iKEP.iFrameMenuOnclick('<c:url value="/collpack/collaboration/workspace/createWorkspaceView.do"/>')"><span><ikep4j:message pre="${prefix}" key="collaborationCreate" /></span></a>				
				</div>
				<!--//blockButton_2 End-->
