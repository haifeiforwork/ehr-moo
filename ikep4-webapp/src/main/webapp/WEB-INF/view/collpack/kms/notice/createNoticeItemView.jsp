...
(function($){	
	$(document).ready(function() {
		...
		$("#listNoticeItemButton").click(function() { 
			$("#normalFileTb").show();
		});
		$("#saveNoticeItemButton").click(function() { 
			var tempEcmFileId = "";  
			var tempEcmFileName = ""; 
			var tempEcmFilePath = "";  
			var tempEcmFileUrl1 = "";    
...
<div class="blockDetail">
	<form id="noticeItemForm" name="noticeItemForm" method="post" action="<c:url value='/collpack/kms/notice/createNoticeItem.do'/>" enctype="multipart/form-data">
...
<c:if test="${ecmrole && user.essAuthCode != 'E9'}">
	...
	<div class="blockButton"> 
		<ul>
			<li><a id="saveNoticeItemButton" class="button" href="#a"><span><ikep4j:message pre='${preButton}' key='save'/></span></a></li>
			<li><a id="listNoticeItemButton" class="button" href="<c:url value='/collpack/kms/notice/listNoticeItemView.do'/>"><span><ikep4j:message pre='${preButton}' key='list'/></span></a></li>
		 </ul>
	</div>
	<!--//blockButton End--> 
