...
<div class="blockDetail">
	<form id="announceItemForm" name="announceItemForm" method="post" action="<c:url value='/collpack/kms/announce/updateAnnounceItem.do'/>">
...
<div class="tableBottom">										
	...
	<div class="blockButton"> 
		<ul>
			...
			<li><a id="listBoardItemButton" class="button" href="<c:url value='/collpack/kms/announce/listAnnounceItemView.do'/>"><span><ikep4j:message pre='${preButton}' key='list'/></span></a></li>
		 </ul>
	</div>
	<!--//blockButton End--> 
</div>
