...
<form id="searchUserPermForm" method="post" onsubmit="return false" action="<c:url value='/collpack/kms/admin/winner/saveWinnerAward.do'/>" enctype="multipart/form-data">
<!--mainContents Start-->	 
<!--pageTitle Start-->
                    ...
                    <table id="infoWinner">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="8">
                                    <input name="winnerName" id="winnerName" type="text" class="inputbox" size="20" />
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="blockButton"> 
                    <ul>
                        ...
                        <li><a id="listTeamButton" class="button" href="<c:url value='/collpack/kms/admin/winner/listAward.do'/>"><span><ikep4j:message key='message.collpack.kms.admin.permission.button.list' /></span></a></li>
                    </ul>
                </div>
