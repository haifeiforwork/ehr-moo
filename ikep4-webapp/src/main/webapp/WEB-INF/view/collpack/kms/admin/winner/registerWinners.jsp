...
<!--pageTitle Start-->
                    ...
                    <table id="infoWinner">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	<spring:bind path="adminWinner.mark">
                                		<input name="${status.expression}" id="${status.expression}" title="mark" class="inputbox" type="text" size="10"  maxlength="4"/>
                                	</spring:bind>
                                </td>
                                <td class="textCenter"><a href="#a" id="addButton"><img src="<c:url value='/base/images/icon/ic_btn_plus.gif'/>" alt="" /></a></td>
                            </tr>
                            <tr>
                            	<th scope="row"><ikep4j:message pre='${preList}' key='name' /></th>
                                <td>
                                	<input name="userName" id="userName" class="inputbox" type="text" size="8" readonly/>
                                    <a class="button_s" id="addPersonButton" href="#a"><span>Search</span></a>
                                </td>
                                <th scope="row"><ikep4j:message pre='${preList}' key='teamName' /></th>
                                <td>
                                <input name="userInfo" value="" size="10" readonly/>
                                <input name="winnerId" value="" type="hidden"/>
                                </td>
                                <th scope="row"><ikep4j:message pre='${preList}' key='regCnt' /></th>
                                <td>
                                	<spring:bind path="adminWinner.regCnt">
                                		<input id="${status.expression}" name="${status.expression}" value="${adminWinner.regCnt}" class="inputbox" type="text" size="10" maxlength="4"/>
                                	</spring:bind>
                                </td>                                
                                <th scope="row"><ikep4j:message pre='${preList}' key='conversionMark' /></th>
                                <td>
                                	<spring:bind path="adminWinner.conversionMark">
                                		<input id="${status.expression}" name="${status.expression}" value="${adminWinner.conversionMark}" class="inputbox" type="text" size="10" maxlength="4"/>
                                	</spring:bind>
                                </td>
                                <td class="textCenter"><a href="#a" id="delButton"><img src="<c:url value='/base/images/icon/ic_btn_minus.gif'/>" alt="" /></a></td>
                            </tr>
                ...
                <div class="blockButton"> 
                    <ul>
                        ...
                        <li><a id="listTeamButton" class="button" href="<c:url value='/collpack/kms/admin/winner/listWinners.do'/>"><span><ikep4j:message key='message.collpack.kms.admin.permission.button.list' /></span></a></li>
                    </ul>
                </div>
