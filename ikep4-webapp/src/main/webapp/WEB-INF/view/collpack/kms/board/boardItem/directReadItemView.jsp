...
<link rel="stylesheet" type="text/css" href="/base/css/layout/layout-default-latest.css" /> 
<link rel="stylesheet" type="text/css" href="/base/css/theme02/jquery_ui_custom.css" />
<link rel="stylesheet" type="text/css" href="/base/css/common.css" />
<link rel="stylesheet" type="text/css" href="/base/css/theme02/theme.css" />
 
<script type="text/javascript" src="/base/js/jquery/jquery-1.6.2.min.js"></script>
<script type="text/javascript" src="/base/js/jquery/jquery-ui-1.8.13.min.without.datepicker.js"></script>
<script type="text/javascript" src="/base/js/jquery/jquery.ui.datepicker.customize.pack.js"></script>
<script type="text/javascript" src="/base/js/jquery/jquery.jstree.pack.js"></script>
<script type="text/javascript" src="/base/js/jquery/jquery.validate-1.8.1.min.js"></script>
<script type="text/javascript" src="/base/js/jquery/plugins.pack.js"></script>
<script type="text/javascript" src="/base/js/etc.plugins.pack.js"></script>
<script type="text/javascript" src="/base/js/langResource/ko.js"></script>
<script type="text/javascript" src="/base/js/common.pack.js"></script>
<script type="text/javascript" src="/base/js/plupload/browserplus-min.js"></script>
<script type="text/javascript" src="/base/js/plupload/plupload.full.min.js"></script>
<script type="text/javascript" src="/base/js/plupload/plupload.browserplus.min.js"></script>
<script type="text/javascript" src="/base/js/plupload/src/javascript/plupload.flash.js"></script>
<script type="text/javascript" src="/base/js/plupload/jquery.plupload.queue.min.customize.js"></script>
<script type="text/javascript" src="/base/js/upload.controll.js"></script>
...
(function($){	 
	...
	$(document).ready(function() { 
		...
		$("#updateBoardItemButton").click(function() {
			if(confirm("수정 하시겠습니까?")) {
				if(${permission.isSystemAdmin}){
					location.href="<c:url value='/collpack/kms/board/boardItem/updateAssessItemView.do?boardId=${boardItem.boardId}&itemId=${boardItem.itemId}&searchConditionString=${searchConditionString}&popupYn=${popupYn}&pageGubun=${pageGubun}'/>";
				}else{
					location.href="<c:url value='/collpack/kms/board/boardItem/updateBoardItemView.do?boardId=${boardItem.boardId}&itemId=${boardItem.itemId}&searchConditionString=${searchConditionString}&popupYn=${popupYn}&pageGubun=${pageGubun}'/>";
				} 
			}  
...
<div id="tagResult">
	...
	<div class="icgroup pt5"> 
		...
		<div class="btn_icbox_sel"> 
			<a href="#a" id="btnMailSend" title="<ikep4j:message pre='${preDetail}' key='emailSend'/>"><img class="ic_mail" src="/base/images/icon/ic_mail_2.gif" alt="<ikep4j:message pre='${preDetail}' key='emailSend'/>" /></a> 
		...
		<div class="btn_icbox"> 
			<a id="createPrintButton"  class="ic_note" href="#a" title="인쇄" ><img src="/base/images/icon/ic_print_02.gif" alt="인쇄" /></a> 
		</div>
		<%--div class="btn_icbox"> 
			...
			<div class="blockTableRead_t">
				...
				<c:if test="${boardItem.itemDelete eq 0}">
					<div class="recommend">
						...
						<span class="doc"><img src="/base/images/icon/ic_recommend.gif" alt="<ikep4j:message pre='${preButton}' key='recommend'/>" /><ikep4j:message pre='${preButton}' key='recommend'/></span></a>
					</div> 	 
				</c:if>  
			</div> 
						...
						<c:if test="${not portletYn}">
							<c:if test="${not popupYn}">
								<c:if test="${permission.isSystemAdmin or (boardItem.registerId eq user.userId and boardItem.status < 3)}">
									<li><a class="button" title="<ikep4j:message pre='${preButton}' key='update'/>" id="updateBoardItemButton" href="#a"><span><ikep4j:message pre='${preButton}' key='update'/></span></a></li> 
								</c:if>
								<c:choose> 
									<c:when test="${permission.isSystemAdmin}">
								...
								<c:if test="${layoutType eq 'layoutNormal'}">
									<li><a class="button" href="<c:url value='/collpack/kms/board/boardItem/listSearchItemView.do?boardId=${boardItem.boardId}&amp;searchConditionString=${searchConditionString}&amp;popupYn=${popupYn}&amp;isKnowhow=${isKnowhow}'/>"><span><ikep4j:message pre='${preButton}' key='list'/></span></a></li>
								</c:if> 
							</c:if>
						</c:if>
					</ul> 
