...
<form id="searchTargetItemForm" method="get" action="<c:url value='/collpack/kms/board/boardItem/listTargetItemView.do' />">  
...
<!--pageTitle Start-->
	...
	<div id="container">
		...
		<div class="blockListTable" id="listDiv"> 
			<%@ include file="/WEB-INF/view/collpack/kms/board/boardItem/listTypeTargetItemView.jsp"%>
