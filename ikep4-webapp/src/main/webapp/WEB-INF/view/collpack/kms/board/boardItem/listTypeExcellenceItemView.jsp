		    ...
		    <c:otherwise>
				...
				<tr>
					...
					<td class="textLeft">
						...
						<span>
							<a name="announceItem" href="<c:url value='/collpack/kms/board/boardItem/readExcellenceItemView.do?itemId=${announceItem.itemId}&isKnowhow=${announceItem.isKnowhow}'/>">${announceItem.title}</a>
						</span>	
					</td>
