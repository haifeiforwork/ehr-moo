		...
		$("#addButton").live("click", function() { 
			...
			("<div class=\"blockDetail\" id='infoWinner_'" + rows+">"
               +"<table>"
                   ...
                   + "                                             <td colspan=\"3\">                                                                                                                                                            "
                   + "                                             	<input name=\"reason\" title=\"\" class=\"inputbox\" type=\"text\" size=\"30\" />                                                                                 "
                   + "                                             </td>                                                                                                                                                           "
...
<form id="searchUserPermForm" method="post" onsubmit="return false" action="<c:url value='/collpack/kms/admin/winner/saveWinnerPeople.do'/>">
<!--mainContents Start-->	 
<!--pageTitle Start-->
                    ...
                    <table id="infoWinner">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th scope="row"><ikep4j:message pre='${preList}' key='reason' /></th>
                                <td colspan="3">
                                <input name="reason" value="" size="30"/>
                                </td>
                                <td class="textCenter"><a href="#a" id="delButton"><img src="<c:url value='/base/images/icon/ic_btn_minus.gif'/>" alt="" /></a></td>
                            </tr>
                        </tbody>
                ...
                <div class="blockButton"> 
                    <ul>
                        ...
                        <li><a id="listTeamButton" class="button" href="<c:url value='/collpack/kms/admin/winner/listHandsomePeople.do'/>"><span><ikep4j:message key='message.collpack.kms.admin.permission.button.list' /></span></a></li>
                    </ul>
                </div>
