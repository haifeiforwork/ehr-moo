...
<div class="TeamColl_img">
	...
	<div class="TeamColl_img_info">
		<div>
			<img src="<c:url value='/base/images/common/title_teamcollaboration_c.png'/>" alt="Team Collaboration" />
		</div>
		
	</div>
	<div class="TeamColl_img_ex">
		<img src="<c:url value='/base/images/common/img_teamcoll_c.gif'/>" alt="" />
	</div>
	</c:if>
	</c:if>
