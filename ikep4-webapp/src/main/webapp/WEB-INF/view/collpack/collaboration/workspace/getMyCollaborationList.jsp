...
<c:set var="prefix"    value="ui.lightpack.board.workspaceItem.listBoardView.list" />
	...
	$jq(document).ready(function() { 
		...
		$("#adminMultiDeleteBoardItemButton, #adminMultiDeleteBoardItemButton1").click(function() {  
			...
			if(confirm("변경하시겠습니까?")) {
				...
				$.post("<c:url value='/collpack/collaboration/workspace/updateCollMenuList.do'/>", {"collaborationId" : "", "itemId" : itemIds.toString(), "popupYn" : ""}) 
...
<form id="searchForm" method="post" action="<c:url value='/collpack/collaboration/workspace/getMyCollaborationList.do'/>" onsubmit="return false;">
