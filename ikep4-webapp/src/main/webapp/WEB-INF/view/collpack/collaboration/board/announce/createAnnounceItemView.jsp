...
<div class="blockDetail">
	<form id="announceItemForm" name="announceItemForm" method="post" action="<c:url value='/collpack/collaboration/board/announce/createAnnounceItem.do'/>">
	<input name="msie"        			type="hidden" value="0" />
	<input name="alarmYn"           type="hidden" value="${boardItem.announceItem}" />
		...
		<tr> 
			...
			<td>
				<div>
					...
					<%-- <spring:bind path="announceItem.alarmYn">   
						<input 
							name="alarmYnCheck" 
							type="checkbox" 
							class="checkbox" 
...
<!--//blockDetail End--> 
<c:if test="${ecmrole && user.essAuthCode != 'E9'}">ecmrole}">
	...
	<div class="blockButton"> 
		<ul>
			...
			<li><a id="listAnnounceItemButton" class="button" href="<c:url value='/collpack/collaboration/board/announce/listAnnounceItemView.do?workspaceId=${announceItem.workspaceId}'/>"><span><ikep4j:message pre='${preButton}' key='list'/></span></a></li>
		 </ul>
	</div>
	<!--//blockButton End--> 
