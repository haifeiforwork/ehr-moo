...
(function($) {
	...
	$jq(document).ready(function() { 
		...
		$jq("#initWorkspaceButton").click(function() {
			if(confirm("생성시의 초기 값으로 변경하시겠습니까?")){
				$jq("textarea[name=introduction]").val("");
...
<script language="JScript" for="twe" event="OnControlInit()">
	...
	document.twe.HtmlValue = $jq("input[name=contents]").val();
</script>
...
<ul>
	...
	<li><a id="initWorkspaceButton" class="button" href="#a" title="<ikep4j:message pre='${preButton}' key='init'/>"><span>초기값으로 변경저장</span></a></li>
</ul>
</div>
<!--//blockButton End-->	
