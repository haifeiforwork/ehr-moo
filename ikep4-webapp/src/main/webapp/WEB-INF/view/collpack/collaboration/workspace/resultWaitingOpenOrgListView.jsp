...
$jq(document).ready(function() { 
	...
	$jq("#searchButton2").click(function() {
	...
	*/
	...
	if($jq('groupIds').length>0){
		$jq('.blockButton').css("display", "");
	}else{
		//alert($jq('groupIds').length);
		$jq('.blockButton').css("display", "none");
	}
...
<div class="blockListTable">
	...
	<div class="tableTop_bgR"></div>
		...
		<div class="tableSearch"> 
			...
			<a id="searchButton2" name="searchButton2" href="#a" class="ic_search"><span>Search</span></a>
		</div>
