...
<ul>
	...
	<li>
		<span>  
			<a href="<c:url value='/collpack/collaboration/board/boardItem/readBoardItemView.do?boardId=${relatedBoardItem.boardId}&itemId=${relatedBoardItem.itemId}&searchConditionString=${searchConditionString}'/>">${relatedBoardItem.title}</a>
