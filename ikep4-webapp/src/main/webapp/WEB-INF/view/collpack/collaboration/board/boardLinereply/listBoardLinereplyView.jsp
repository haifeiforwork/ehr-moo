...
(function($){	 
	...
	*/	
	createLinereply = function() {    
		...
		$.post('<c:url value="/collpack/collaboration/board/boardLinereply/createBoardLinereply.do"/>', $("#boardLinereplyForm").serialize())
	...
	*/
	createReplyLinereply = function(linereplyId) {    
		...
		$.post('<c:url value="/collpack/collaboration/board/boardLinereply/createReplyBoardLinereply.do"/>', formObject.serialize())
		.success(function(data) { 
			loadBoardLinereplyList();
	...
	*/
	updateLinereply = function(linereplyId) { 
		...
		$.post('<c:url value="/collpack/collaboration/board/boardLinereply/updateBoardLinereply.do"/>', formObject.serialize())
		.success(function(data) { 
			loadBoardLinereplyList();
	...
	*/		
	userDeleteBoardLinereply = function(itemId, linereplyId) { 
		if(confirm("<ikep4j:message pre='${preMessage}' key='delete' />")) {
		    $.post("<c:url value='/collpack/collaboration/board/boardLinereply/userDeleteBoardLinereply.do'/>", {"itemId" : itemId , "linereplyId" : linereplyId}) 
		    .success(function(data) { 
		    	loadBoardLinereplyList(); 
		    })
		    .error(function(event, request, settings) { alert("error"); });
	...
	*/	
	adminDeleteBoardLinereply = function(itemId, linereplyId) { 
		if(confirm("<ikep4j:message pre='${preMessage}' key='delete' />")) {
		    $.post("<c:url value='/collpack/collaboration/board/boardLinereply/adminDeleteBoardLinereply.do'/>", {"itemId" : itemId , "linereplyId" : linereplyId}) 
