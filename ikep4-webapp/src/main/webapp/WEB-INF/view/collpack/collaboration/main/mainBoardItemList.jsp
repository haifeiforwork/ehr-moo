				...
				<tbody>
					...
					<tr name="boardItemLine">
						<td>
							...
							<div class="summaryViewCon"><a onclick="javascript:viewItem('<c:url value='/collpack/collaboration/board/boardItem/readBoardItemLinkView.do?workspaceId='/>${boardItem.workspaceId}&amp;boardId=${boardItem.boardId}&amp;itemId=${boardItem.itemId}&amp;docPopup=true')" href="#a"><ikep4j:extractTextBody text="${boardItem.contents}" length="300"/></a></div>
