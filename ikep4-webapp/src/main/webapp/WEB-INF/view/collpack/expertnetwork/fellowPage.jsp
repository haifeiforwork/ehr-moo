...
<c:forEach var="item" items="${fellowList}">
<li>
...
<c:if test="${0 eq fn:length(fellowList)}"><li><div class="emptyRecord"><ikep4j:message pre="${messagePrefix}" key="emptyRecord"/></div></li></c:if>
