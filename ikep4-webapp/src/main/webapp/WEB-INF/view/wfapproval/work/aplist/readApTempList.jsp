...
<div id="pageTitle">
	...
	<div id="pageLocation">
		<ul>
			...
			<li>Approval</li>
			<li><ikep4j:message pre='ui.wfapproval.work.aplist.subtitle' key='request' /></li>
...
<!--blockSearch Start-->
<form id="searchForm" method="post" action="<c:url value='/wfapproval/work/aplist/listApTemp.do' />">
		...
		<table summary="검색">
			...
			<tbody>
				<tr>
					...
					<th scope="row" width="5%"><ikep4j:message pre='${preSearch}' key='${status.expression}' /></th>
					<td width="35%">
						<input name="${status.expression}" value="${status.value}" type="text" class="inputbox" title='<ikep4j:message pre='${preSearch}' key='${status.expression}' />'  size="35" />
					</td>
					</spring:bind>
