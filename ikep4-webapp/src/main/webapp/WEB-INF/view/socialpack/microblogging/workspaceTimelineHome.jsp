...
(function($) {
	...
	getTimeline = function( standardType){
		...
		$jq.get("<c:url value='/socialpack/microblogging/workspaceTimelineList.do'/>", 
				// 홈피주인id					   ,조회해온 데이터를 앞/뒤에 붙일건지  , 조회기준 MblogId	
				{'workspaceId':'${workspaceId}', 'standardType':standardType, 'standardMblogId':standardMblogId}, 
				function(data) {
					//alert(data);
