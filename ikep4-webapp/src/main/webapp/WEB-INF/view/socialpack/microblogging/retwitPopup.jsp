		...
		<div class="corner_RoundBox05">
			...
			<div class="microblog_write_list"  id="addonDiv">
				...
				<form id="mblogForm" name="mblogForm" method="post"  action="">
					<input type ="hidden" name="mblogType" value = "2" />
					<input type ="hidden" name="retweetMblogId" value = "${originMblog.mblogId}" /> 
					<input type ="hidden" name="mbgroupId" id="mbgroupId" value = "${originMblog.mbgroupId}" />
					<textarea id="contents" name="contents" title="<ikep4j:message pre='${preLabel}' key='contents'  />" cols="" rows="3"  class="w100" >[RT]@${originMblog.registerId} ${originMblog.contents}</textarea>
