...
(function($) {
	...
	getTimeline = function( standardType){
		...
		$jq.get("<c:url value='/socialpack/microblogging/teamTimelineList.do'/>", 
				// team의 id					   ,조회해온 데이터를 앞/뒤에 붙일건지  , 조회기준 MblogId	
				{'ownerGroupId':'${groupId}', 'standardType':standardType, 'standardMblogId':standardMblogId}, 
				function(data) {
					//alert(data);
