...
(function($){	
	$(document).ready(function() {    
		    ...
		    submitHandler : function(form) {    
		    	...
		    	if(useActXEditor == "Y"){
			    	if ($.browser.msie) {
			    		...
			    		createActiveXEditorFileLink(tweBodyObj,"socialBoardItemForm");
		...
		var uploaderOptions = {
	    		<c:if test="${empty socialBoardItem.fileDataListJson}">files : [],</c:if> 
			 	<c:if test="${not empty socialBoardItem.fileDataListJson}">files : ${socialBoardItem.fileDataListJson},</c:if> 
...
<script language="JScript" for="twe" event="OnControlInit()">
	var form = document.socialBoardItemForm;
