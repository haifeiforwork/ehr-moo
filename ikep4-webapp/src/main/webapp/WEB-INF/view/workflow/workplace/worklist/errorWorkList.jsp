...
<form id="myForm" method="post" action="<c:url value='/workflow/workplace/worklist/errorWorkList.do' />">
	<!--blockSearch Start-->
				...
				<c:choose>
					<c:when test="${!empty searchResult.entity}">
						...
						<tr onmouseover="mouseOver(this);" onmouseout="mouseOut(this);">
							...
							<td>${errorWorkList.partitionName}</td>					
							...
							<td>
								<c:choose>
									<c:when test="${user.localeCode == portal.defaultLocaleCode}">
		  								${errorWorkList.userName}
	  								</c:when>
	  								<c:otherwise>
	  									${errorWorkList.userEnglishName}
	  								</c:otherwise>
	  							</c:choose>
							</td>
							<td><ikep4j:timezone date="${errorWorkList.procStartDate}" pattern="yyyy.MM.dd HH:mm"/></td>
