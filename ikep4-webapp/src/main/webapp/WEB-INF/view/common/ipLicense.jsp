...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/base/css/theme01/jquery_ui_custom.css"/>" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/base/css/common.css"/>" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/base/css/theme01/theme.css"/>" />
</head>
			...
			<img src="<c:url value="/base/images/icon/ic_nopage2.gif"/>" alt="" /><span>
				<c:choose>
					<c:when test="${empty exception.entity }">
						현재 사용하고 계신 IP주소가 라이센스 IP주소와 일치하지 않습니다.
					</c:when>
					<c:otherwise>
						${exception.entity}
					</c:otherwise>
