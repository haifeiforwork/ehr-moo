...
import com.lgcns.ikep4.lightpack.cafe.board.dao.BoardItemVersionDao;
 ...
 * 
 * @author happyi1018
 * @version $Id: BoardItemVersionServiceImpl.java 14298 2011-06-03 02:29:54Z
 *          jghong $
 */
@Service("cfBoardItemVersionServiceImpl")
...
public class BoardItemVersionServiceImpl implements BoardItemVersionService {
	...
	public int returnBoardItemVersion(String versionId, User user) {
		...
		if (fileDataList != null) {
			...
			this.fileService.copyForTransferVersion(fileIdList, newVersionId, IKepConstant.ITEM_TYPE_CODE_CAFE, user);
		}
