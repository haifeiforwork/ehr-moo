 ...
 *
 * @author ${user}
 * @version $$Id: AwardLinereplyDao.java 16240 2011-08-18 04:08:15Z giljae $$
 */
public interface AwardLinereplyDao extends GenericDao<AwardLinereply, String> {
	 ...
	 * @return 댓글 목록
	 */
	List<AwardLinereply> listBySearchCondition(AwardLinereplySearchCondition searchCondtion);
	 ...
	 * @return 댓글 갯수
	 */
	Integer countBySearchCondition(AwardLinereplySearchCondition searchCondtion);
	 ...
	 * 스탭을 업데이트 한다.
	 *
	 * @param awardLinereply the award linereply
	 */
	void updateStep(AwardLinereply awardLinereply);
	 ...
	 */
	void logicalDelete(AwardLinereply awardLinereply);
