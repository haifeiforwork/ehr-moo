...
@Controller
@RequestMapping(value = "/lightpack/planner/portlet/personalSchedule")
public class PersonalScheduleController extends BaseController{
	...
	public ModelAndView normalView(@RequestParam String portletConfigId, @RequestParam(value="personalScheduleDate", required=false) String personalScheduleDate, @RequestParam(value="personalUserId", required=false) String personalUserId) {
		ModelAndView mav = new ModelAndView("lightpack/planner/portlet/personalSchedule/normalView");
		
		User user = (User) getRequestAttribute("ikep.user");
		
		if(StringUtil.isEmpty(personalUserId)) {
			personalUserId = user.getUserId() + "^M";
		}
		
		List<User> teamUserList = userService.listTeamUser(user.getGroupId());
		...
		mav.addObject("teamUserList", teamUserList);
