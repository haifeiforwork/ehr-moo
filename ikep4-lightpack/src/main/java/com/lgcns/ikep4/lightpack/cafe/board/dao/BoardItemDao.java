...
/**
 * 게시글 DAO 게시글 IKEP4_BD_ITEM 테이블 CRUD와 목록조회등 DB와의 연동을 담당하는 클래스이다.
 * 
 * @author ${user}
 * @version $$Id: BoardItemDao.java 18152 2012-04-19 08:05:55Z yu_hs $$
 */
public interface BoardItemDao extends GenericDao<BoardItem, String> {
	 ...
	 */
	List<BoardItem> listByItemIdArray(Map<String, Object> params);
	...
	/**
	 * 특정 카페에 최신에 등록된 게시글을 가져온다.
	 * 
	 * @param parameter boardId 게시판 ID, count 글갯수
	 * @return
	 */
	List<BoardItem> listRecentBoardItemForCafe(BoardItemSearchCondition searchCondition);
