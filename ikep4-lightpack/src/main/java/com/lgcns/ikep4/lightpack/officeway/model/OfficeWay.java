 ...
 * @version $Id$
 */
public class OfficeWay extends BaseObject {
	...
	public String getOfficeWayId() {
		return officewayId;
	}

	public void setOfficeWayId(String officewayId) {
		this.officewayId = officewayId;
	}
