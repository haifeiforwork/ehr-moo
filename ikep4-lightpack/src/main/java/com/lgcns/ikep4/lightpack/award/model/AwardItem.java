 ...
 *
 * @author ${user}
 * @version $$Id: AwardItem.java 16240 2011-08-18 04:08:15Z giljae $$
 */
public class AwardItem extends BaseObject {
	...
	private List<AwardItem> replyItemThreadList;

	/** 관련글 리스트. */
	private List<AwardItem> relatedAwardItemList;
	...
	private String companyNoticeAwardId;
	
	//독서자 리스트 //입력용
	private List<String> readerList;
	
	//독서자 리스트 //조회수정용
	private List<AwardItemReader> awardItemReaderList;
	...
	private String awardMgntNo;					//	수상자료 관리 번호
	private String awardKind;					//	수상 종류
	private String companyCode;					//	회사코드
	private String awardTitle;					//	행사명
	private String awardTxt;					//	행사내역
	private String publisher;					//	발행처
	private String awardDate;					//	수상/수여 일자
	private String awardGrade;					//	등급
	private String awardMaterial;				//	수상자료
	private String storageLocCd;				//	보관위치 지역코드
	private String storageLocDetail;			//	보관위치 상세내역
	private String resDeptId;					//	주관 부서코드
	private String awardPromotionDetail;		//	수상자료 홍보 상세
	private String writeEmpNo;					//	게시자 사원번호
	private String writeDate;					//	게시일자
	private String addFileInfo;					//	첨부파일 정보
	private String fileItemId;					//	파일항목ID
	private String storageLocTxt;				//	보관위치 지역코드 txt
	private String awardKindTxt;                //	수상 종류 txt
	private String companyCodeTxt;              //	회사코드 txt
	private String awardMaterials;				//	수상자료콤마

	
	public List<AwardItemReader> getAwardItemReaderList() {
		return awardItemReaderList;
	}

	public void setAwardItemReaderList(List<AwardItemReader> awardItemReaderList) {
		this.awardItemReaderList = awardItemReaderList;
	}
	...
	public String getCompanyNoticeAwardId() {
		return companyNoticeAwardId;
	}

	public void setCompanyNoticeAwardId(String companyNoticeAwardId) {
		this.companyNoticeAwardId = companyNoticeAwardId;
	}
	 ...
	 */
	public List<AwardItem> getReplyItemThreadList() {
	 ...
	 */
	public void setReplyItemThreadList(List<AwardItem> replyItemThreadList) {
	...
	/**
	 * Gets the related award item list.
	 *
	 * @return the related award item list
	 */
	public List<AwardItem> getRelatedAwardItemList() {
		return this.relatedAwardItemList;
	}

	/**
	 * Sets the related award item list.
	 *
	 * @param relatedAwardItemList the new related award item list
	 */
	public void setRelatedAwardItemList(List<AwardItem> relatedAwardItemList) {
		this.relatedAwardItemList = relatedAwardItemList;
	}
	...
	public String getAwardMgntNo() {
		return awardMgntNo;
	}

	public void setAwardMgntNo(String awardMgntNo) {
		this.awardMgntNo = awardMgntNo;
	}
	...
	public String getAwardTxt() {
		return awardTxt;
	}

	public void setAwardTxt(String awardTxt) {
		this.awardTxt = awardTxt;
	}
	...
	public String getAwardMaterial() {
		return awardMaterial;
	}

	public void setAwardMaterial(String awardMaterial) {
		this.awardMaterial = awardMaterial;
	}

	public String getStorageLocCd() {
		return storageLocCd;
	}

	public void setStorageLocCd(String storageLocCd) {
		this.storageLocCd = storageLocCd;
	}

	public String getStorageLocDetail() {
		return storageLocDetail;
	}

	public void setStorageLocDetail(String storageLocDetail) {
		this.storageLocDetail = storageLocDetail;
	}
	...
	public String getAwardPromotionDetail() {
		return awardPromotionDetail;
	}

	public void setAwardPromotionDetail(String awardPromotionDetail) {
		this.awardPromotionDetail = awardPromotionDetail;
	}
	...
	public String getAddFileInfo() {
		return addFileInfo;
	}

	public void setAddFileInfo(String addFileInfo) {
	...
	public String getStorageLocTxt() {
		return storageLocTxt;
	}

	public void setStorageLocTxt(String storageLocTxt) {
		this.storageLocTxt = storageLocTxt;
	}

	public String getAwardKindTxt() {
		return awardKindTxt;
	}

	public void setAwardKindTxt(String awardKindTxt) {
		this.awardKindTxt = awardKindTxt;
	}
	...
	public String getAwardMaterials() {
		return awardMaterials;
	}

	public void setAwardMaterials(String awardMaterials) {
		this.awardMaterials = awardMaterials;
	}
