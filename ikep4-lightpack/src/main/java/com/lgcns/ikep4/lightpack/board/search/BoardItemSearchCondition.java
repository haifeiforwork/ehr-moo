...
public class BoardItemSearchCondition extends SearchCondition {
	...
	private List<String> searchWorkplaces;
	...
	public List<String> getSearchWorkplaces() {
		return searchWorkplaces;
	}

	public void setSearchWorkplaces(List<String> searchWorkplaces) {
		this.searchWorkplaces = searchWorkplaces;
	}
	...
	public Boolean getBoardAdminUse() {
		return boardAdminUse;
	}

	public void setBoardAdminUse(Boolean boardAdminUse) {
		this.boardAdminUse = boardAdminUse;
	}
