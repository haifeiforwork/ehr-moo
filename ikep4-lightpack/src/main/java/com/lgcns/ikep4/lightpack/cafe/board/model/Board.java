 ...
 * 
 * @author ${user}
 * @version $$Id: Board.java 16240 2011-08-18 04:08:15Z giljae $$
 */
public class Board extends BaseObject {

	public static final String BOARD_ACL_CLASS_NAME = "Cafe-BD";

	public static final String CAFE_MANAGER = "Cafe";
	...
	/**
	 * 게시판을 수정할 경우 게시판 내 문서에 대한 권한도 같이 수정하도록 요청된 상태값 ( N : 문서권한 변경 없음, A : 문서권한
	 * 변경 요청, E : 문서권한 변경 완료)
	 **/
