...
public class BoardLinereplyDaoImpl extends GenericDaoSqlmap<BoardLinereply, String> implements BoardLinereplyDao {
	...
	private static final String NAMESPACE = "lightpack.board.dao.boardLinereply.";
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#updateStep(com.lgcns.ikep4.lightpack.board.model.BoardLinereply)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#logicalDelete(com.lgcns.ikep4.lightpack.board.model.BoardLinereply)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#physicalDelete(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#physicalDeleteThreadByLinereplyId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#physicalDeleteThreadByItemThread(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#physicalDeleteThreadByItemId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#listBySearchCondition(com.lgcns.ikep4.lightpack.board.search.BoardLinereplySearchCondition)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#countBySearchCondition(com.lgcns.ikep4.lightpack.board.search.BoardLinereplySearchCondition)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.board.dao.BoardLinereplyDao#countChildren(java.lang.String)
	 */
