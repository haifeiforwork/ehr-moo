 ...
 *
 * @author ${user}
 * @version $$Id: AwardRecommendDao.java 16240 2011-08-18 04:08:15Z giljae $$
 */
public interface AwardRecommendDao extends GenericDao<AwardRecommend, AwardRecommendPK> {
