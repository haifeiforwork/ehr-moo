 ...
 */
package com.lgcns.ikep4.lightpack.cafe.board.interceptor.impl;
 ...
 * 
 * @author ${user}
 * @version $$Id: BoardFileUploadInterceptor.java 14377 2011-06-03 09:08:15Z
 *          jghong $$
 */
@Component
@Repository("cfBoardFileUploadInterceptor")
public class BoardFileUploadInterceptor implements FileUploadInterceptor {
	...
	public UPLOAD_ERROR_MESSAGE beforeProcess(Map<String, Object> parameterMap) {
		...
		// Cafe 아이디
		// final String cafeId = String.valueOf(parameterMap.get("cafeId"));
		// 파일의 이름
		...
		if (fileSize > imageFileSize) {
			//throw new IKEP4ApplicationException("${fileOriginalFilename} file size is over max limit.",
