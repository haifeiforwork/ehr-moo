 ...
 */
@Controller
@RequestMapping(value = "/lightpack/meetingroom/favorite")
public class MeetingRoomByFavoriteController extends BaseController {
	...
	public ModelAndView meetingRoomMain(@RequestParam(value="date", required=false, defaultValue="0") long date) {
		...
		ModelAndView mav = new ModelAndView("lightpack/meetingroom/tab/favorite/meetingRoomMain");//	/lightpack/meetingroom/favorite/meetingRoomMain
	...
	public ModelAndView cartooletcMain(@RequestParam(value="date", required=false, defaultValue="0") long date) {
		...
		ModelAndView mav = new ModelAndView("lightpack/meetingroom/tab/favorite/cartooletcMain");//	/lightpack/meetingroom/day/meetingRoomMain
	...
	public @ResponseBody List<MeetingRoom> meetingRoomList(@RequestParam(value="curDate", required=false, defaultValue="0") long curDate) {
		...
		try {
			...
			List<Map<String, Object>> scheduleList = scheduleService.readMeetingRoomScheduleByFavorite(portal.getPortalId(), user.getUserId(), today, today);
	...
	public @ResponseBody List<Cartooletc> cartooletcList(String mid, @RequestParam(value="curDate", required=false, defaultValue="0") long curDate) {
		...
		try {
			...
			List<Map<String, Object>> scheduleList = scheduleService.readCartooletcScheduleByFavorite(portal.getPortalId(), user.getUserId(), today, today);
			if(scheduleList != null && scheduleList.size() > 0) {
