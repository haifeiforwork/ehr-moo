...
public class BoardCode {
	...
	private final List<Code<String>> followBoardPermission = Arrays.asList(new Code<String>("1",
			"message.lightpack.cafe.common.boardItem.permission.sameBoard"), new Code<String>("0",
			"message.lightpack.cafe.common.boardItem.permission.additional"));

	@SuppressWarnings("unchecked")
	private final List<Code<String>> boardTypeList = Arrays.asList(new Code<String>("0",
			"message.lightpack.cafe.common.board.boardType.board"), new Code<String>("1",
			"message.lightpack.cafe.common.board.boardType.dummy"), new Code<String>("2",
			"message.lightpack.cafe.common.board.boardType.urlLink"));

	@SuppressWarnings("unchecked")
	private final List<Code<String>> listTypeList = Arrays.asList(new Code<String>("0",
			"message.lightpack.cafe.common.searchCondition.listType.listType"), new Code<String>("1",
			"message.lightpack.cafe.common.searchCondition.listType.summaryType"), new Code<String>("2",
			"message.lightpack.cafe.common.searchCondition.listType.galleryType"), new Code<String>("3",
			"message.lightpack.cafe.common.searchCondition.listType.simpleType"));

	@SuppressWarnings("unchecked")
	private final List<Code<String>> permissionList = Arrays.asList(new Code<String>("1",
			"message.lightpack.cafe.board.boardAdmin.createBoardView.detail.readPermission.all"), new Code<String>("2",
			"message.lightpack.cafe.board.boardAdmin.createBoardView.detail.readPermission.associate"), new Code<String>(
			"3", "message.lightpack.cafe.board.boardAdmin.createBoardView.detail.readPermission.member"), new Code<String>(
			"4", "message.lightpack.cafe.board.boardAdmin.createBoardView.detail.readPermission.manager"));
