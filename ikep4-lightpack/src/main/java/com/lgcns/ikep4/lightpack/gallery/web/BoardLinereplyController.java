 ...
 * 댓글 컨트롤 클래스
 */
@Controller("pfBoardLinereplyController")
@RequestMapping(value = "/lightpack/gallery/boardLinereply")
public class BoardLinereplyController extends BaseController {
	...
	public boolean isSystemAdmin(User user) {
		return this.aclService.isSystemAdmin("PF", user.getUserId());
	}
	...
	public ModelAndView listBoardLinereplyView(
			BoardLinereplySearchCondition searchCondition,
		...
		BoardItem boardItem = this.boardItemService.readBoardItemMasterInfo(searchCondition.getItemId());
