 ...
 */
@Repository("pfBoardReferenceDaoImpl")
public class BoardReferenceDaoImpl extends GenericDaoSqlmap<BoardReference, BoardReferencePK> implements BoardReferenceDao {
	...
	private static final String NAMESPACE = "lightpack.gallery.dao.boardReference.";
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.lightpack.gallery.dao.BoardReferenceDao#removeByItemId(java.lang.String)
	 */
