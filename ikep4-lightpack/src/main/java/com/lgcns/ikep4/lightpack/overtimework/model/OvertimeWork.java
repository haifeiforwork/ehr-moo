 ...
 */
package com.lgcns.ikep4.lightpack.overtimework.model;
 ...
 * @version $Id$
 */
public class OvertimeWork extends BaseObject {
	...
	public String getOvertimeWorkId() {
		return overtimeworkId;
	}

	public void setOvertimeWorkId(String overtimeworkId) {
