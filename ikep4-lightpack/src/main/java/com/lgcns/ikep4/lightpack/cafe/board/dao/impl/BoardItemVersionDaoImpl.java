 ...
 * 
 * @author happyi1018
 * @version $Id: BoardItemVersionDaoImpl.java 14298 2011-06-03 02:29:54Z jghong
 *          $
 */
@Repository("cfBoardItemVersionDaoImpl")
public class BoardItemVersionDaoImpl extends GenericDaoSqlmap<BoardItemVersion, String> implements BoardItemVersionDao {

	private static final String NAMESPACE = "lightpack.cafe.board.dao.boardItemVersion.";
