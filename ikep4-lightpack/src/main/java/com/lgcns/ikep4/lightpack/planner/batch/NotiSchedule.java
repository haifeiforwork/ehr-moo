 ...
 */
public class NotiSchedule extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		try {
			...
			this.alarmPlannerService = (AlarmPlannerService) appContext.getBean("alarmPlannerService");
			...
			this.alarmPlannerService.doAlarmJobSchedule(jobTime, interval, fileUrl);
		} catch (Exception e) {
