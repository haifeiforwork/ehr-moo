...
@Controller("cfBoardImageFileUploadController")
@RequestMapping(value = "/lightpack/cafe/board/boardImageUpload")
public class BoardImageFileUploadController extends BaseController {
	...
	public ModelAndView uploadFile(String cafeId, String boardId, String targetId, String editorAttach,
