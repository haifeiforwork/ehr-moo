 ...
 * @version $Id: CalendarControllerTests.java 16302 2011-08-19 08:43:50Z giljae $
 */
...
public class CalendarControllerTests {
	...
	public void init() throws Exception {
		...
		request.setRequestURI("/lightpack/planner/calendar/init.do");
		ModelAndView mav = handlerAdapter.handle(request, response, controller);
		ModelAndViewAssert.assertViewName(mav, "lightpack/planner/calendar");
	}
