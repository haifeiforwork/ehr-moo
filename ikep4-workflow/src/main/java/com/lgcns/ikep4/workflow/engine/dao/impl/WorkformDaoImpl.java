...
public class WorkformDaoImpl extends GenericDaoSqlmap<WorkItemBean, String> implements WorkformDao {

	Log log = LogFactory.getLog(WorkformDaoImpl.class);
	...
	public WorkItemBean getWorkform(WorkItemBean workItemBean) {
		return (WorkItemBean) sqlSelectForObject("com.lgcns.ikep4.workflow.engine.model.WorkItemBean.workform", workItemBean);
	}	
