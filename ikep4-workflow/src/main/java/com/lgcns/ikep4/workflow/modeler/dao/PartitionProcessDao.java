...
/**
 * PartitionProcess DAO
 *
 * @author 이승민(lsm3174@built1.com)
 * @version $Id: PartitionProcessDao.java 16245 2011-08-18 04:28:59Z giljae $
 */
public interface PartitionProcessDao extends GenericDao<PartitionProcess, String> {
	/**
	 * 전체 PartitionProcess 리스트
	 * 
	 * @return
	 */
