 ...
 *
 * @author 이재경
 * @version $Id: WorkplaceListService.java 16245 2011-08-18 04:28:59Z giljae $
 */
@Transactional
public interface WorkplaceListService extends GenericService<WorkItemBean, String> {
