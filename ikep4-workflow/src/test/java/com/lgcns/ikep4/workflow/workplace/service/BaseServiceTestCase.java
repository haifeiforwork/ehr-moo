 ...
 * @version $Id: BaseServiceTestCase.java 16245 2011-08-18 04:28:59Z giljae $
 */
@ContextConfiguration({"classpath:/configuration/spring/context-dao.xml", "classpath:/configuration/spring/context-service.xml"})
//@ContextConfiguration({"classpath:context-test.xml", "classpath:/configuration/spring/context-service.xml"})
