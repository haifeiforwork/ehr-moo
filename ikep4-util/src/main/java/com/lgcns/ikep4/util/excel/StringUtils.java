 ...
 * @version $Id: StringUtils.java 16247 2011-08-18 04:54:29Z giljae $
 */
public class StringUtils extends org.springframework.util.StringUtils
{
  ...
  public static boolean isContinousLetter(String target, int permissableCount, boolean isForward)
  {
    ...
    int tempCount = 0;
    --permissableCount;
    int i = 0; for (int targetLength = target.length(); i < targetLength; ++i) {
      ...
      if (tempCount == permissableCount) return true;
  ...
  public static String toDoubleByteCharSetString(String halfString)
  {
    ...
    if (hasText(halfString)) {
      ...
      for (int i = 0; i < len; ++i) {
        ...
        if (c == ' ') {
          fullString = fullString + String.valueOf(12288);
        }
  ...
  public static String decamelize(String s, String splitPattern, boolean toUpperCase)
  {
    ...
    int i = 1; for (int length = s.length(); i < length; ++i) {
      char c = s.charAt(i);
