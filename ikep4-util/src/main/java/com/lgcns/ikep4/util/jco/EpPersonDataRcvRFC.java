...
@Service("epPersonRcv")
@Transactional
public class EpPersonDataRcvRFC  {
	
	protected final Log log = LogFactory.getLog(this.getClass());
    private String functionName = "Z_HR_EP_PERSON_DATA_SEND";
     ...
     */
    public List<UserDetail> EpPersonDataRcvRFC(HttpServletRequest request )  {
