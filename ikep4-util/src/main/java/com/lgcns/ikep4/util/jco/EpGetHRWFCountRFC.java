 ...
 */
public class EpGetHRWFCountRFC  {
	
	protected final Log log = LogFactory.getLog(this.getClass());
    private String functionName = "Z_HR_WF_COUNT";
     ...
     */
    public String EpGetHRWFCountRFC(HttpServletRequest request, String userID )  {
		...
		function.getImportParameterList().setValue("I_PERNR", userID);
