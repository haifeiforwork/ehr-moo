...
/**
 * SocialAnalyzerBatchJob 등록, 수정, 삭제
 * 
 * @author 주길재
 * @version $Id: SocialAnalyzerBatchJob.java 17097 2011-12-14 02:35:36Z giljae $
 */
@ContextConfiguration({ "classpath:/context-batch-dao.xml",
	"classpath:/context-batch-service.xml", "classpath:/context-batch-test.xml" })
public class SocialAnalyzerBatchJob extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
	private QuartzJobService quartzJobService;

	/**
	 * SocialAnalyzerBatchJob Job을 생성한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
	...
	/**
	 * SocialAnalyzerBatchJob Job을 삭제한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
