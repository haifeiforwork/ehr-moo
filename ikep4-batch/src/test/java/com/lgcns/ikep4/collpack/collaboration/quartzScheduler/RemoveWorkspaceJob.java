 ...
 * 
 * @author 주길재
 * @version $Id: RemoveWorkspaceJob.java 17097 2011-12-14 02:35:36Z giljae $
 */
@ContextConfiguration({ "classpath:/context-batch-dao.xml",
	"classpath:/context-batch-service.xml", "classpath:/context-batch-test.xml" })
public class RemoveWorkspaceJob extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
	private QuartzJobService quartzJobService;

	/**
	 * RemoveWorkspace Job을 생성한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
