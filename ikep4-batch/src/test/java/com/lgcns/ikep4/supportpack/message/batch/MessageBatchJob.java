 ...
 */
package com.lgcns.ikep4.supportpack.message.batch;
...
/**
 * Message Batch Job 등록,수정,삭제
 * 
 * @author 주길재
 * @version $Id: MessageBatchJob.java 17097 2011-12-14 02:35:36Z giljae $
 */
@ContextConfiguration({ "classpath:/context-batch-dao.xml",
	"classpath:/context-batch-service.xml", "classpath:/context-batch-test.xml" })
public class MessageBatchJob extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
	private QuartzJobService quartzJobService;

	/**
	 * Message Batch Job을 생성한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
