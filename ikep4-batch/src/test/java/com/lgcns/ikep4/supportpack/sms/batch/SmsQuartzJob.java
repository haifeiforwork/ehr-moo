 ...
 */
package com.lgcns.ikep4.supportpack.sms.batch;
 ...
 * 
 * @author 주길재
 * @version $Id: SmsQuartzJob.java 17097 2011-12-14 02:35:36Z giljae $
 */
@ContextConfiguration({ "classpath:/context-batch-dao.xml",
	"classpath:/context-batch-service.xml", "classpath:/context-batch-test.xml" })
public class SmsQuartzJob extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
