 ...
 */
package com.lgcns.ikep4.servicepack.assessmentmgmt.batch;
...
/**
 * AssessmentManagementQuartz Job
 *
 * @author 주길재
 * @version $Id: AssessmentMgmtQuartzJob.java 17097 2011-12-14 02:35:36Z giljae $
 */
@ContextConfiguration({ "classpath:/context-batch-dao.xml",
	"classpath:/context-batch-service.xml", "classpath:/context-batch-test.xml" })
public class AssessmentMgmtQuartzJob extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
	private QuartzJobService quartzJobService;

	/**
	 * AssessmentManagementQuartz Job을 생성한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
	...
	/**
	 * AssessmentManagementQuartz Job을 삭제한다.
	 */
	@Ignore
	@Test
	@Rollback(false)
