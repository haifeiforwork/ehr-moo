 ...
 * @version $Id: JobRankDao.java 19023 2012-05-31 06:36:51Z malboru80 $
 */
public interface JobRankDao extends GenericDao<JobRank, String> {
	...
	/**
	 * 해당 직급코드의 정렬순서를 목록에서 한단계 아래로 내림
	 * 
	 * @param map 이동 조건
	 * @return
	 */
	...
	/**
	 * 직급코드를 위/아래로 이동 후 정렬 순서를 업데이트 함
	 * 
	 * @param jobRank 업데이트할 직급 객체
	 */
