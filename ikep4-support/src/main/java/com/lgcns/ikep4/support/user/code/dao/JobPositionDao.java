 ...
 * @version $Id: JobPositionDao.java 19023 2012-05-31 06:36:51Z malboru80 $
 */
public interface JobPositionDao extends GenericDao<JobPosition, String> {
	...
	/**
	 * 직위코드를 위/아래로 이동 후 정렬 순서를 업데이트 함
	 * 
	 * @param jobPosition 업데이트할 직위 객체
	 */
