...
/**
 * Access Control List(ACL) Dao 구현체 (정적 System)
 * 
 * @author 주길재(giljae@gmail.com)
 * @version $Id: AccessControlListDaoImpl.java 1137 2011-02-23 06:57:18Z giljae
 *          $
 */
@Repository(value = "aclSystemDao")
public class ACLSystemDaoImpl extends GenericDaoSqlmap<Object, String> implements ACLDao {
	// 상수 정의
	interface Constants {
		...
		final String NAMESPACE = "support.user.security.acl.dao.ACLSystem.";
	}
	...
	public void updateBasePermission(ACLResourcePermission aclResourcePermission, String permissionId) {
		...
		sqlInsert(Constants.NAMESPACE + "updateBasePermission", parameterMap);
	}
	...
	public void removeGroupPermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeGroupPermissionByPortalId", paramMap);
	}
	...
	public void removeRolePermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeRolePermissionByPortalId", paramMap);
	}
	...
	public void removeUserPermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeUserPermissionByPortalId", paramMap);
	}
	...
	public void removeJobClassPermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeJobClassPermissionByPortalId", paramMap);
	}
	...
	public void removeJobDutyPermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeJobDutyPermissionByPortalId", paramMap);
	}
	...
	public void removeExpUserPermission(String permissionId, String portalId) {
		...
		sqlDelete(Constants.NAMESPACE + "removeExpUserPermissionByPortalId", paramMap);
	}
	...
	public List<User> listSystemAdminAsUser(List<String> permissionIdList) {
		...
		try {
			userList = getSqlMapClientTemplate().getSqlMapClient().queryForList(
					Constants.NAMESPACE + "listSystemAdminAsUser", permissionIdList);
		} catch (SQLException sqlException) {
			// TODO: Exception 작성 필요
		}
	...
	public List<Group> listSystemAdminAsGroup(List<String> permissionIdList) {
		...
		try {
			groupList = getSqlMapClientTemplate().getSqlMapClient().queryForList(
					Constants.NAMESPACE + "listSystemAdminAsGroup", permissionIdList);
		} catch (SQLException sqlException) {
			// TODO: Exception 작성 필요
		}
	...
	public List<User> listSystemAdminAsAll(List<String> permissionIdList) {
		...
		try {
			userList = getSqlMapClientTemplate().getSqlMapClient().queryForList(
					Constants.NAMESPACE + "listSystemAdminAsAll", permissionIdList);
		} catch (SQLException sqlException) {
			// TODO: Exception 작성 필요
		}
