...
public interface CustomerFinanceDao extends GenericDao<Object,String> {
     ...
     * @return
     */
    Integer countBySearchCondition(FinanceSearchCondition searchCondition );
    
    /**
     * 고객 기본정보 리스트 조회
     */ 
    List<Finance> listFinanceBySearchCondition(FinanceSearchCondition searchCondition);
     ...
     * @return
     */
    List<FinanceCondition> readHistory( String id );
    
    List<FinanceCondition> profitLossList( String id );
    
    List<FinanceCondition> conditionList( String id );
    
    List<FinanceCondition> rateList( String id );
    /**
    ...
    void updateFinanceCondition( FinanceCondition financeCondition );
    
    void updateFinanceRate( Finance finance );

    /**
     * 고객사의 연혁정보를 저장한다. (수정)
     * @param financeCondition
     */
    void saveFinanceCondition( FinanceCondition financeCondition );
     ...
     */
    void updateSapCustomer( CustomerBasicInfo customerFinance );
     ...
     * @param customerFinance
     */
    void updateFinanceSAPSync( String sapId );
    /**
     * SAP 고객정보 SYNC(인물정보)
     * @param customerFinance
     */
     ...
     * @return 
     */
    List<Finance> listSAPFinancebySearchCondition( FinanceSearchCondition searchCondition );
     ...
     * @return
     */
    Integer countBySearchConditionForSAP( FinanceSearchCondition searchCondition );
    
    Integer countFinance( Finance finance );
    
    Integer countFinanceCondition( FinanceCondition financeCondition );
    
    Integer countFinanceRate( Finance finance );
