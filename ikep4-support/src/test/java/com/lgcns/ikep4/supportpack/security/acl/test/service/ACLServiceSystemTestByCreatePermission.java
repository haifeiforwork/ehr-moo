 ...
 * 
 * @author 주길재
 * @version $Id: ACLServiceTestByCreatePermission.java 1955 2011-03-08 04:54:17Z
 *          giljae $
 */
@ContextConfiguration({"classpath:/configuration/spring/context-dao.xml", "classpath:/configuration/spring/context-service.xml"}) 
public class ACLServiceSystemTestByCreatePermission extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void createResourcePermission() {
		...
		assertNotNull(aclService.getSystemPermission(this.className, this.resourceName, this.operationName));
	}
