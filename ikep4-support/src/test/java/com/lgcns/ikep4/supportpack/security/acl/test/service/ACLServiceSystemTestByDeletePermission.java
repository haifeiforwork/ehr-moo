 ...
 * 
 * @author 주길재
 * @version $Id: ACLServiceTestByDeletePermission.java 1955 2011-03-08 04:54:17Z
 *          giljae $
 */
@ContextConfiguration({"classpath:/configuration/spring/context-dao.xml", "classpath:/configuration/spring/context-service.xml"}) 
public class ACLServiceSystemTestByDeletePermission extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void deletePermission() {
		// 리소스에 대한 권한 정보 일괄 삭제
		aclService.deleteSystemPermission("BBS-BD-Item", "TestResourceGIL");
		assertNull(aclService.getSystemPermission("BBS-BD-Item", "TestResourceGIL", "READ"));
	}
	...
	public void getPermission() {
		ACLResourcePermission aclResourcePermission = aclService.getSystemPermission("BBS-BD-Item", "TestResourceGIL", "READ");
