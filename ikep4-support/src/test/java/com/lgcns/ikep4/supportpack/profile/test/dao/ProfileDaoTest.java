 ...
 * @version $Id: ProfileDaoTest.java 16258 2011-08-18 05:37:22Z giljae $
 */
...
public class ProfileDaoTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testUpdateProfile() {
		...
		User result = userService.read("user39");
	...
	public void testUpdateProfileStaus() {
		...
		userService.updateProfileStaus(this.user);
		User result = userService.read("user39");
	...
	public void testUpdatePictureId() {
		...
		userService.updatePictureId(this.user);
		User result = userService.read("user39");
	...
	public void testUpdateProfilePictureId() {
		...
		userService.updateProfilePictureId(this.user);
		User result = userService.read("user39");
	...
	public void testUpdateTwitterInfo() {
		...
		userService.updateTwitterInfo(this.user);
		User result = userService.read("user39");
	...
	public void testUpdateFacebookInfo() {
		...
		userService.updateFacebookInfo(this.user);
		User result = userService.read("user39");
	...
	public void testUpdateExportField() {
		...
		userService.updateExportField(this.user);
		User result = userService.read("user39");
	...
	public void testUpdateCurrentJob() {
		...
		userService.updateCurrentJob(this.user);
		User result = userService.read("user39");
		assertEquals(this.user.getCurrentJob(), result.getCurrentJob());
