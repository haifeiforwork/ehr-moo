 ...
 * @version $Id: TagItemDaoTestCase.java 16258 2011-08-18 05:37:22Z giljae $
 */
public class TagItemDaoTestCase extends BaseDaoTestCase  {
	...
	public void testRead() {
		...
		Tag result = tagItemDao.read(tag.getTagItemId(), tag.getTagItemType());
	...
	public void testUpdate() {
		...
		tag.setTagItemName("title2");
		
		tagItemDao.update(tag);
		
		Tag result = tagItemDao.read(tag.getTagItemId(), tag.getTagItemType());
		
		assertEquals("title2", result.getTagItemName());
	}
	...
	public void testDelete() {
		...
		tagItemDao.remove(tag.getTagItemId(), tag.getTagItemType());
