...
/**
 * ACLContentDao의 기능을 테스트 한다.
 * 
 * @author 주길재
 * @version $Id: ACLDaoContentTest.java 16258 2011-08-18 05:37:22Z giljae $
 */
@ContextConfiguration({ "classpath:/configuration/spring/context-dao.xml",
		"classpath:/configuration/spring/context-service.xml" })
public class ACLDaoContentTest extends AbstractTransactionalJUnit4SpringContextTests {
	@Autowired
	...
	public void testListResourcePermission() {
		...
		assertNotNull(aclContentDao.listResourcePermission("BBS-BD-Item", operationNames, "TestResourceGIL"));
	}
	...
	public void testListAllPermission() {
		String[] operationNames = { "READ" };
		List<Map<String, Object>> resourcePermissionList = aclContentDao.listResourcePermission("BBS-BD-Item",
				operationNames, "TestResourceGIL");
		...
		assertNotNull(aclContentDao.listAllPermission(permissionIds, "user1"));
	}
	...
	public void testGetResourceId() {
		assertNotNull(aclContentDao.getResourceId("BBS-BD-Item", "TestResourceGIL"));
	}
	...
	public void testListPermissionId() {
		String resourceId = aclContentDao.getResourceId("BBS-BD-Item", "TestResourceGIL");
		assertNotNull(aclContentDao.listPermissionId(resourceId));
	}
	...
	public void testGetBasePermission() {
		assertNotNull(aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ"));
	}
	...
	public void testListGroupPermission() {
		Map<String, Object> permissionMap = aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ");
		String permissionId = permissionMap.get("permissionId").toString();
		assertNotNull(aclContentDao.listGroupPermission(permissionId));
	}
	...
	public void testListRolePermission() {
		Map<String, Object> permissionMap = aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ");
		String permissionId = permissionMap.get("permissionId").toString();
		assertNotNull(aclContentDao.listRolePermission(permissionId));
	}
	...
	public void testListUserPermission() {
		Map<String, Object> permissionMap = aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ");
		String permissionId = permissionMap.get("permissionId").toString();
		assertNotNull(aclContentDao.listUserPermission(permissionId));
	}
	...
	public void testListJobClassPermission() {
		Map<String, Object> permissionMap = aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ");
		String permissionId = permissionMap.get("permissionId").toString();
		assertNotNull(aclContentDao.listJobClassPermission(permissionId));
	}
	...
	public void testListJobDutyPermission() {
		Map<String, Object> permissionMap = aclContentDao.getBasePermission("BBS-BD-Item", "TestResourceGIL", "READ");
		String permissionId = permissionMap.get("permissionId").toString();
		assertNotNull(aclContentDao.listJobDutyPermission(permissionId));
	}
	...
	public void testRemoveGroupPermission() {
		...
		for (String permissionId : permissionIdList) {
			assertEquals(aclContentDao.listGroupPermission(permissionId).size(), 0);
		}
	}
	...
	public void testRemoveRolePermission() {
		...
		for (String permissionId : permissionIdList) {
			assertEquals(aclContentDao.listRolePermission(permissionId).size(), 0);
		}
	}
	...
	public void testRemoveUserPermission() {
		...
		for (String permissionId : permissionIdList) {
			assertEquals(aclContentDao.listUserPermission(permissionId).size(), 0);
		}
	}
	...
	public void testRemoveJobClassPermission() {
		...
		for (String permissionId : permissionIdList) {
			assertEquals(aclContentDao.listJobClassPermission(permissionId).size(), 0);
		}
	}
	...
	public void testRemoveJobDutyPermission() {
		...
		for (String permissionId : permissionIdList) {
			assertEquals(aclContentDao.listJobDutyPermission(permissionId).size(), 0);
		}
	}
	...
	public void testRemoveBasePermission() {
		...
		assertEquals(aclContentDao.listPermissionId(resourceId).size(), 0);
	}

	/**
	 * 리소스 삭제 릴레이션이 연결된 테이블 부터 순차적으로 삭제 해야 한다.
	 */
	@Test
