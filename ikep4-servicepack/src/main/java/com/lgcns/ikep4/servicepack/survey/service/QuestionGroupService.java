 ...
 *
 * @author ihko11
 * @version $Id: QuestionGroupService.java 16244 2011-08-18 04:11:42Z giljae $
 */
@Transactional
public interface QuestionGroupService extends GenericService<QuestionGroup,String> {
	/**
	 * 설문 그룹 리스트
	 * @param surveyId
	 * @return
