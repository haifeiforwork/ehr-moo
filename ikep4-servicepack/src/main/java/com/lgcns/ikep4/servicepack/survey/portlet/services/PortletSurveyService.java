 ...
 */
package com.lgcns.ikep4.servicepack.survey.portlet.services;
 ...
 *
 * @author ihko11
 * @version $Id: PortletSurveyService.java 16244 2011-08-18 04:11:42Z giljae $
 */
@Transactional
public interface PortletSurveyService extends GenericService<Survey, String>{
	/**
	 * 설문 신청 리스트
