...
public class AnswerDaoTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testExists() {
		String pk = answerDao.create(answer);
		boolean exists = answerDao.exists(pk); 
	...
	public void testCreate() { 
		String pk = answerDao.create(answer);
		Answer result = answerDao.get(pk); 
	...
	public void testUpdate() {
		...
		String pk = answerDao.create(answer);
		answer.setUpdateDate(new Date());
		answer.setUpdaterId("system");
		answer.setUpdaterName("관리자");
	...
	public void removeAllBySurveyId() {
		String pk = answerDao.create(answer);
		answerDao.removeAllBySurveyId(survey.getSurveyId());
		Answer result = answerDao.get(pk);
		Assert.assertNull(result); 
	}
	...
	@Test 
	public void removeAllByQuestionId() {
		String pk = answerDao.create(answer);
	...
	public void removeAllByGroupId() {
		String pk = answerDao.create(answer);
		answerDao.removeAllByGroupId(questionGroup.getQuestionGroupId());
		Answer result = answerDao.get(pk);
		Assert.assertNull(result); 
	}
	...
	@Test
	public void getAllByQuestionId() {
		answerDao.create(answer);
		List<Answer> surveyItemList = answerDao.getAllByQuestionId(question.getQuestionId());
