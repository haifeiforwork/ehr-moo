 ...
 * @version $Id: FrFeedbackServiceTest.java 16289 2011-08-19 06:52:01Z giljae $
 */
public class FrFeedbackServiceTest extends BaseServiceTestCase {
	...
	public void setUp() {
		...
		frFeedback.setRegisterId("user1");
		
		frFeedbackService.createAgreement(pk, "user1", discussionId);
		frFeedbackService.createOpposition(pk, "user1", discussionId);
	...
	public void testRemoveAgreement() {
		...
		try{
			frFeedbackService.removeAgreement(pk, "user1", discussionId);
			assertTrue(true);
		} catch(Exception e){
			assertTrue(false);
		}
	...
	@Test
	public void testRemoveOpposition() {
		
		try{
			frFeedbackService.removeOpposition(pk, "user1", discussionId);
			assertTrue(true);
		} catch(Exception e){
			assertTrue(false);
		}
	...
	public void testExists() {
		...
		try{
			frFeedbackService.exists(pk, "0", "user1");
			assertTrue(true);
		} catch(Exception e){
			assertTrue(false);
		}
