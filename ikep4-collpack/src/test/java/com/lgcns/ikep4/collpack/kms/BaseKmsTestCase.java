 ...
 */
@ContextConfiguration(locations = { "classpath*:/configuration/spring/context*.xml" })
@TransactionConfiguration(transactionManager="transactionManager", defaultRollback=false)
@Transactional
public abstract class BaseKmsTestCase extends AbstractTransactionalJUnit4SpringContextTests {
