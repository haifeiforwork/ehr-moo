...
public abstract class BaseDaoTestCase extends  AbstractTransactionalJUnit4SpringContextTests {
	...
	protected static final String itemId ="1112000";
	protected static final String workspaceId    ="100000150086";
	protected static final String itemSeqId ="1";
	protected static final Integer itemDisplay = 1;
	protected static final String title ="TEST TITLE";
	protected static final String contents ="TEST CONTENT_TEST CONTENT_TEST CONTENT_TEST CONTENT";
	protected static final Integer hitCount = 200;
	protected static final Integer attachFileCount = 5;
	protected static final Integer itemDelete = 1;
	protected static final String registerId ="user10";
	protected static final String registerName ="사용자10";
	protected static final String updaterId ="user10";
	protected static final String updaterName ="사용자10";
	
	protected static final String isOwner ="1";
