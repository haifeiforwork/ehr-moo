 ...
 * BoardDao 구현체 클래스
 */
@Repository("kmsBoardDaoImpl")
public class BoardDaoImpl extends GenericDaoSqlmap<Board, String> implements BoardDao {

	/** The Constant NAMESPACE. */
	private static final String NAMESPACE = "collpack.kms.board.dao.board.";
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.collpack.kms.board.dao.BoardDao#listByBoardRootId(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.collpack.kms.board.dao.BoardDao#getParents(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lgcns.ikep4.collpack.kms.board.dao.BoardDao#getChildren(java.lang.String)
	 */
	...
	public List<Board> boardList(String isKnowhow) {
		return this.sqlSelectForList(NAMESPACE + "boardList", isKnowhow);
	}
	...
	public List<Board> getKmsMapName(String boardId) {
		return (List<Board>)this.sqlSelectForList(NAMESPACE + "getKmsMapName", boardId);
	}
	/**
	 * 게시판 하위 목록 조회
	 */
