package com.lgcns.ikep4.collpack.kms.announce.service;
...
//	AnnounceItem readAnnounceItem(String userId, String itemId, String workspaceId);
	AnnounceItem readAnnounceItem(String userId, String itemId);
...
//	void adminMultiDeleteAnnounceItem(List<String> itemIds, String workspaceId, String portalId);
	void adminMultiDeleteAnnounceItem(List<String> itemIds, String portalId);
...
//	void createAnnounceLinkItem(String announceItemId);
