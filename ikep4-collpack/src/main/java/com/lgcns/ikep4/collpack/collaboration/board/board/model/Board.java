...
public class Board extends BaseObject {
	...
	public static final String BOARD_ACL_CLASS_NAME = "Coll-BD";

	public static final String BOARD_ITEM_ACL_CLASS_NAME = "Coll-BD-Item";

	public static final String BOARD_PERMISSION_CLASS_NAME = "BBS";

	public static final String COLLABORATION_MANAGER = "Collaboration";
