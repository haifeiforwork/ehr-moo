 ...
 *
 * @author 최현식
 * @version $Id: BoardPermission.java 16236 2011-08-18 02:48:22Z giljae $
 */
public class BoardPermission extends BaseObject {
	...
	public BoardPermission(Boolean isSystemAdmin, Boolean isWritePermission, Boolean isReadPermission) {
		super();
	...
	public void setIsWritePermission(Boolean isWritePermission) {
		this.isWritePermission = isWritePermission;
	}

	public void setIsReadPermission(Boolean isReadPermission) {
		this.isReadPermission = isReadPermission;
	}
}
