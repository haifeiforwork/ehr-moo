...
import com.lgcns.ikep4.collpack.collaboration.board.board.model.Board.BoardTypeBoard;
import com.lgcns.ikep4.collpack.collaboration.board.board.model.Board.CategoryTypeBoard;
import com.lgcns.ikep4.collpack.collaboration.board.board.model.Board.LinkTypeBoard;
 ...
 * 게시판 관리 컨트롤 클래스
 */
@Controller("wsBardAdminController")
@RequestMapping(value = "/collpack/collaboration/board/boardAdmin")
public class BoardAdminController extends BaseController {
	...
	@ResponseStatus(HttpStatus.OK)
	public @ResponseBody
	List<TreeNode> listChildrenBoardMenu(@RequestParam(value = "workspaceId") String workspaceId,
			AccessingResult accessResult, @RequestParam(value = "boardId") String boardId) {
	...
	public ModelAndView createLink(@RequestParam(value = "workspaceId") String workspaceId,
		...
		if (result.hasErrors()) {
			...
			return new ModelAndView("forward:/collpack/collaboration/board/boardAdmin/createBoardView.do")
		...
		return new ModelAndView("redirect:/collpack/collaboration/board/boardAdmin/readBoardView.do")
	...
	public ModelAndView updateLinkTypeBoard(@RequestParam(value = "workspaceId") String workspaceId,
		...
		if (result.hasErrors()) {
			this.setErrorAttribute("board", board, result);
			return new ModelAndView("forward:/collpack/collaboration/board/boardAdmin/updateBoardView.do").addObject(
	...
	public ModelAndView deleteBoard(@RequestParam(value = "workspaceId") String workspaceId,
		...
		// this.boardAdminService.physicalDeleteBoard(boardId);
		this.boardAdminService.logicalDeleteBoard(boardId);
		return new ModelAndView("redirect:/collpack/collaboration/board/boardAdmin/listBoardView.do")
				.addObject("workspaceId", workspaceId).addObject("leftBoardMenuReload", true)
				.addObject("boardRootId", board.getBoardRootId());
	}
}
