...
import com.lgcns.ikep4.collpack.collaboration.board.board.model.BoardRecommendPK;
import com.lgcns.ikep4.framework.core.dao.ibatis.GenericDaoSqlmap;

/**
 * BoardRecommendDao 구현체 클래스
 */
@Repository("wsBoardRecommendDaoImpl")
public class BoardRecommendDaoImpl extends GenericDaoSqlmap<BoardRecommend, BoardRecommendPK> implements BoardRecommendDao {
	...
	private static final String NAMESPACE = "collpack.collaboration.board.board.dao.boardRecommend.";
