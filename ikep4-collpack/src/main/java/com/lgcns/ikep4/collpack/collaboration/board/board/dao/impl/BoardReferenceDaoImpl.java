...
import com.lgcns.ikep4.collpack.collaboration.board.board.model.BoardReferencePK;
import com.lgcns.ikep4.framework.core.dao.ibatis.GenericDaoSqlmap;

/**
 * BoardReferenceDao 구현체 클래스
 */
@Repository("wsBoardReferenceDaoImpl")
public class BoardReferenceDaoImpl extends GenericDaoSqlmap<BoardReference, BoardReferencePK> implements BoardReferenceDao {
	...
	private static final String NAMESPACE = "collpack.collaboration.board.board.dao.boardReference.";
