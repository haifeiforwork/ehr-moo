...
public interface BoardAdminService {
	...
	List<Board> boardList(String isKnowhow);
	/**
	 * 게시판의권한 정보를 조회한다.
	 *
	 * @param userId 사용자 ID
	 ...
	 */
	public void moveBoardByWorkspace(String orgWorkspaceId,String orgBoardId,String targetWorkspaceId,String targetBoardId,User user);
