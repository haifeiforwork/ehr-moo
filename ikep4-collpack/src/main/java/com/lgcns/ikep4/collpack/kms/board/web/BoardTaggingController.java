 ...
 * 댓글 컨트롤 클래스
 */
@Controller("kmsBoardTaggingController")
@RequestMapping(value = "/collpack/kms/board/boardTagging")
public class BoardTaggingController {
	...
	public ModelAndView listRelatedBoardItemView(RelatedBoardItemSearchCondition searchCondition,
		...
		ModelAndView modelAndView = new ModelAndView().addObject("searchResult", searchResult)
									...
									.addObject("isSystemAdmin", aclService.isSystemAdmin("Kms", loginUserId))
