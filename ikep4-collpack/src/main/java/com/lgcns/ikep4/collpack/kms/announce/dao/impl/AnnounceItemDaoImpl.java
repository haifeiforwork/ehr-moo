package com.lgcns.ikep4.collpack.kms.announce.dao.impl;
...
@Repository("kmsAnnounceItemDaoImpl")
public class AnnounceItemDaoImpl extends GenericDaoSqlmap<AnnounceItem, String> implements AnnounceItemDao {
	private static final String NAMESPACE = "collpack.kms.announce.dao.announceItem."; 
	...
	/*
	 * 공지사항 게시물 리스트 ##
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#listBySearchCondition(com.lgcns.ikep4.collpack.kms.board.announce.search.AnnounceItemSearchCondition)
	 */
	...
	/*
	 * 공지사항 게시물 리스트 카운트 ##
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#countBySearchCondition(com.lgcns.ikep4.collpack.kms.board.announce.search.AnnounceItemSearchCondition)
	 */
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#updateHitCount(java.lang.String)
	 */
...
//	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#createLinkAnnounce(com.lgcns.ikep4.collpack.kms.board.announce.model.AnnounceItem)
//	 */
...
//	}
	...
	/*
	 * 공지사항 게시물 읽기 ##
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#getAnnounce(java.lang.String, java.lang.String)
	 */
//	public AnnounceItem getAnnounce(String itemId, String workspaceId) {
	public AnnounceItem getAnnounce(String itemId) {
...
//		param.put("workspaceId", workspaceId);
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#removeAnnounceShareLink(java.lang.String)
	 */
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#physicalDeleteAnnounceLink(java.lang.String)
	 */
//	public void removeAnnounceLink(String itemId,String workspaceId) {
	public void removeAnnounceLink(String itemId) {
...
//		param.put("workspaceId", workspaceId);
	...
	/*
	 * 공지사항 게시물 삭제 ##
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#physicalDeleteAnnounceItem(java.lang.String)
	 */
	...
	/*
	 * 해당 게시글 조회참조 정보 일괄삭제
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#removeAnnounceReference(java.lang.String)
	 */
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#countChildWorkspaceBySearchCondition(com.lgcns.ikep4.collpack.kms.board.announce.search.AnnounceItemSearchCondition)
	 */
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#listChildWorkspaceBySearchCondition(com.lgcns.ikep4.collpack.kms.board.announce.search.AnnounceItemSearchCondition)
	 */
	...
	/*
	 * 참조테이블 insert
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#createAnnounceItemReference(java.lang.String)
	 */
	...
	/*
	 * 참조테이블 정보 카운트
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#getAnnounceReference(java.lang.String, java.lang.String)
	 */
	 ...
	 * @see com.lgcns.ikep4.collpack.kms.board.announce.dao.AnnounceItemDao#listAnnounceItemByPortlet(java.util.Map)
	 */
...
//		return (List<AnnounceItem>)this.sqlSelectForList(NAMESPACE + "listDeleteAnnounceByWorkspace", workspaceId);
		return (List<AnnounceItem>)this.sqlSelectForList(NAMESPACE + "listDeleteAnnounceByWorkspace");

	}
	public AnnounceItem getTopAnnounceItem() {
		return (AnnounceItem)this.sqlSelectForObject(NAMESPACE + "getTopAnnounceItem");
	}
}
