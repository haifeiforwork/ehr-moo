 ...
 */
@Service("wsBoardLinereplyServiceImpl")
// @Transactional
public class BoardLinereplyServiceImpl implements BoardLinereplyService {
	...
	public SearchResult<BoardLinereply> listBoardLinereplyBySearchCondition(
		...
		Integer count = this.boardLinereplyDao
		...
		if (searchCondtion.isEmptyRecord()) {
			...
			List<BoardLinereply> boardLinereplyList = this.boardLinereplyDao
					.listBySearchCondition(searchCondtion);

			result = new SearchResult<BoardLinereply>(boardLinereplyList,
					searchCondtion);
		}
