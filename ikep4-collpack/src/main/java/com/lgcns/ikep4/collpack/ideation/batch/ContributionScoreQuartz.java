...
/**
 * 기여 점수 저장, 랭킹 수정 배치 처리 클래스
 * 
 * @author 이동희(loverfairy.com)
 * @version $Id: ContributionScoreQuartz.java 12417 2011-05-20 07:53:57Z
 *          loverfairy $
 */
public class ContributionScoreQuartz extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		try {
			...
			this.idUserActivitiesService.updateContributionScore();
		} catch (Exception e) {
