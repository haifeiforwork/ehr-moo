...
import com.lgcns.ikep4.collpack.kms.board.service.BoardItemVersionService;
 ...
 *          happyi1018 $
 */
@Controller("kmsBoardItemVersionController")
@RequestMapping(value = "/collpack/kms/board/boardItemVersion")
