...
public class WorkspaceCode {
	...
	private static final List<Code<String>> WORKSPACE_STATUS_LIST = Arrays.asList(
			new Code<String>("WO", "WO"),	// 개설신청
	...
	@SuppressWarnings("unchecked")
	private static final List<Code<String>> MEMBER_LEVEL_LIST = Arrays.asList(
			new Code<String>("1", "1"),		// 시샵
	...
	@SuppressWarnings("unchecked")
	private static final List<Code<String>> MEMBER_JOIN_TYPE = Arrays.asList(
			new Code<String>("0", "0"),		// 본인 가입
			new Code<String>("1", "1")		// 시샵 가입
	);	
	@SuppressWarnings("unchecked")
	private static final List<Code<String>> LIST_TYPE_LIST = Arrays.asList(
			new Code<String>("D-LT",  "ui.communication.commoon.searchCondition.listType.defaultLayoutList"),
			new Code<String>("D-SY",  "ui.communication.commoon.searchCondition.listType.defaultLayoutSummary"),
			new Code<String>("D-GY",  "ui.communication.commoon.searchCondition.listType.defaultLayoutGallery"),
			new Code<String>("2F-LT", "ui.communication.commoon.searchCondition.listType.2FrameLayoutList"),
			new Code<String>("2F-SY", "ui.communication.commoon.searchCondition.listType.2FrameLayoutSummary"),
			new Code<String>("2F-GY", "ui.communication.commoon.searchCondition.listType.2FrameLayoutGallery") 
	);
	...
	private static final List<Code<Integer>> APPROVAL_REJECT_LIST = Arrays.asList(
			new Code<Integer>(1, "ui.communication.commoon.code.approval"),
			new Code<Integer>(0, "ui.communication.commoon.code.reject")
	); 
	...
	public List<Code<String>> getWorkspaceStatusList() {
		return WORKSPACE_STATUS_LIST;
	}
