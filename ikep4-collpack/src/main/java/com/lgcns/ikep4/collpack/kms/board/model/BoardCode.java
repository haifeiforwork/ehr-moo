...
public class BoardCode {
	...
	private final List<Code<String>> permissionList = Arrays.asList(new Code<String>("1",
			"message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.all"), new Code<String>(
			"2", "message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.associate"),
			new Code<String>("3",
					"message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.member"),
			new Code<String>("4",
					"message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.individual"));
	
	@SuppressWarnings("unchecked")
	private final List<Code<String>> kmsPermissionList = Arrays.asList(new Code<String>("1",
			"message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.all"), 
			new Code<String>("4",
					"message.collpack.kms.boardAdmin.createBoardView.detail.readPermission.individual"));
