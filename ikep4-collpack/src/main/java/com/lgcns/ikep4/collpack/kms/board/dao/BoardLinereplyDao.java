...
public interface BoardLinereplyDao extends GenericDao<BoardLinereply, String> {
	...
	void deleteLinereplyScore(BoardLinereply boardLinereply);
	...
	public boolean scoreExists(BoardLinereply boardLinereply);
	
	public boolean linereplyExists(BoardLinereply boardLinereply);
	
	public BoardLinereply insertScore(BoardLinereply boardLinereply);
