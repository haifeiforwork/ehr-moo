 ...
 */
@Controller
@RequestMapping(value = "/approval/work/portlet/request")
public class ApprPortletMyRequestController extends BaseController{
	...
	private static final String USER_CONFIG_MODULE_ID = "portlet.approval.myrequest";
	...
	public ModelAndView normalView(@RequestParam String portletConfigId) {
		ModelAndView mav = new ModelAndView("approval/work/portlet/request/normalView");
		...
		apprListSearchCondition.setListType("myRequestList");
	...
	public ModelAndView configView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/request/configView");
	...
	public ModelAndView maxView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/request/maxView");
