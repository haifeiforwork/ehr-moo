 ...
 */
@Controller
@RequestMapping(value = "/approval/work/portlet/display")
public class ApprPortletDisplayController extends BaseController{
	...
	private static final String USER_CONFIG_MODULE_ID = "portlet.approval.display";
	...
	public ModelAndView normalView(@RequestParam String portletConfigId) {
		ModelAndView mav = new ModelAndView("approval/work/portlet/display/normalView");
		...
		apprDisplaySearchCondition.setPagePerRecord(pagePerRecord);
	...
	public ModelAndView configView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/display/configView");
	...
	public ModelAndView maxView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/display/maxView");
