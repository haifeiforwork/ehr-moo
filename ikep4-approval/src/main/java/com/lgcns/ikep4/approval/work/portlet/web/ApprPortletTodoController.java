 ...
 */
@Controller
@RequestMapping(value = "/approval/work/portlet/todo")
public class ApprPortletTodoController extends BaseController{
	...
	private static final String USER_CONFIG_MODULE_ID = "portlet.approval.todo";
	...
	public ModelAndView normalView(@RequestParam String portletConfigId) {
		ModelAndView mav = new ModelAndView("approval/work/portlet/todo/normalView");
	...
	public ModelAndView configView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/todo/configView");
	...
	public ModelAndView maxView(@RequestParam String portletConfigId) {
		...
		ModelAndView mav = new ModelAndView("approval/work/portlet/todo/maxView");
